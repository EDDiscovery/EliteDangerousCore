...
namespace EliteDangerousCore
{
    public static class EliteDangerousCalculations
    {
        ...
        public static List<FSDSpec> FSDListOverchargeFSD = new List<FSDSpec>(        
            new FSDSpec[] {                                             
                          //C    R     pc lc  mop  mfpj
                new FSDSpec(2,  "E",   2, 8,  60,  0.6),                
                new FSDSpec(2,  "D",   2, 12, 90,  0.9),                
                new FSDSpec(2,  "C",   2, 12, 90,  0.9),
                new FSDSpec(2,  "B",   2, 12, 90,  10.9),
                new FSDSpec(2,  "A",   2, 13, 100, 1),

                new FSDSpec(3,  "E",   2.15, 8,  100, 1.2),
                new FSDSpec(3,  "D",   2.15, 12, 150, 1.8),
                new FSDSpec(3,  "C",   2.15, 12, 150, 1.8),
                new FSDSpec(3,  "B",   2.15, 12, 150, 1.8),
                new FSDSpec(3,  "A",   2.15, 13, 167, 1.9),

                new FSDSpec(4,  "E",   2.3, 8,  350, 2),
                new FSDSpec(4,  "D",   2.3, 12, 525, 3),
                new FSDSpec(4,  "C",   2.3, 12, 525, 3),
                new FSDSpec(4,  "B",   2.3, 12, 525, 3),
                new FSDSpec(4,  "A",   2.3, 13, 585, 3.2),

                new FSDSpec(5,  "E",   2.45, 8,  700,  3.3),
                new FSDSpec(5,  "D",   2.45, 12, 1050, 5),
                new FSDSpec(5,  "C",   2.45, 12, 1050, 5),
                new FSDSpec(5,  "B",   2.45, 12, 1050, 5),
                new FSDSpec(5,  "A",   2.45, 13, 1175, 5.2),

                new FSDSpec(6,  "E",   2.6, 8,  1200, 5.3),
                new FSDSpec(6,  "D",   2.6, 12, 1800, 8),
                new FSDSpec(6,  "C",   2.6, 12, 1800, 8),
                new FSDSpec(6,  "B",   2.6, 12, 1800, 8),
                new FSDSpec(6,  "A",   2.6, 13, 2000, 8.3),

                new FSDSpec(7,  "E",   2.75, 8,  1800, 8.5),
                new FSDSpec(7,  "D",   2.75, 12, 2700, 12.8),
                new FSDSpec(7,  "C",   2.75, 12, 2700, 12.8),
                new FSDSpec(7,  "B",   2.75, 12, 2700, 12.8),
                new FSDSpec(7,  "A",   2.75, 13, 3000, 13.1)
            }
        );
