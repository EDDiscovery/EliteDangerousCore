...
namespace EliteDangerousCore
{
    ...
    public class OrganicEstimatedValues
    {
        ...
        public static Values GetValuePreU14(string codexname)     // null if not found
        {
            return Array.Find(valuelistpre14, x => codexname.StartsWith(x.Codexname, StringComparison.InvariantCultureIgnoreCase));
        }

        private static Values[] valuelistpre14 = new Values[] {
        ...
        public static Values GetValuePostU14(string codexname)     // null if not found
        {
            return Array.Find(valuelistU14, x => codexname.StartsWith(x.Codexname, StringComparison.InvariantCultureIgnoreCase));
        }

        private static Values[] valuelistU14 = new Values[] {
            ...
            new Values("Bacterium Nebulus", 5289900, "$Codex_Ent_Bacterial_02"),
            ...
            new Values("Concha Biconcavis", 19010800, "$Codex_Ent_Conchas_04"),
            ...
            new Values("Roseum Sinuous Tubers", 1514500, "$Codex_Ent_Tube"),
            new Values("Prasinum Sinuous Tubers", 1514500, "$Codex_Ent_TubeABCD_01"),
            new Values("Albidum Sinuous Tubers", 1514500, "$Codex_Ent_TubeABCD_02"),
            new Values("Caeruleum Sinuous Tubers", 1514500, "$Codex_Ent_TubeABCD_03"),
            new Values("Lindigoticum Sinuous Tubers", 1514500, "$Codex_Ent_TubeEFGH_01"),
            new Values("Violaceum Sinuous Tubers", 1514500, "$Codex_Ent_TubeEFGH_02"),
            new Values("Viride Sinuous Tubers", 1514500, "$Codex_Ent_TubeEFGH_03"),
            new Values("Blatteum Sinuous Tubers", 1514500, "$Codex_Ent_TubeEFGH"),
