...
namespace EliteDangerousCore
{
    ...
    public class MaterialCommodityMicroResourceType
    {
        ...
        static Dictionary<string, MaterialCommodityMicroResourceType> cachelist;
        ...
        private static bool AddEntry(CatType catname, Color colour, string aliasname, ItemType typeofit, MaterialGroupType mtg, string shortname, string fdName, bool comrare = false)
        {
            ...
            MaterialCommodityMicroResourceType mc = new MaterialCommodityMicroResourceType(catname, aliasname, MCMR.AccidentLogs, fdn, typeofit, mtg, shortname, colour, comrare);
            cachelist.Add(fdn, mc);     // on purpose, an add to cause errors if dup
            return true;
        }
        ...
        static void FillOld()
        {
            ...
            AddManu("Heat Exposure Specimen", ItemType.VeryRare, MaterialGroupType.NA, "HEXS", "tg_abrasion01");
