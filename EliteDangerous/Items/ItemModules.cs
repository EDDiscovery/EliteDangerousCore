    ...
    public partial class ItemData
    {
        ...
        static void CreateModules()
        {
            ...
            vanitymodules = new Dictionary<string, ShipModule>   // DO NOT USE DIRECTLY - public is for checking only
            {
                ...
                {"paintjob_python_luminous_stripe_04", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Python Luminous Stripe 4") },
                ...
                {"paintjob_vulture_bartecki_bartecki", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Vulture Bartecki Bartecki") },
...
{ "paintjob_sidewinder_vibrant_yellow", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Sidewinder Vibrant Yellow") },
{ "cobramkiii_shipkit1_bumper2", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Cobramkiii Shipkit 1 Bumper 2") },
{ "paintjob_cobramkiii_tactical_blue", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Cobramkiii Tactical Blue") },
...
{ "paintjob_krait_mkii_metallic2_chrome", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Krait Mkii Metallic 2 Chrome") },
{ "paintjob_dolphin_tactical_grey", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Dolphin Tactical Grey") },
{ "paintjob_type9_industrial_03", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Type 9 Industrial 3") },
{ "paintjob_federation_corvette_squadron_gold", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Federation Corvette Squadron Gold") },
...
{ "paintjob_krait_mkii_corrosive_02", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Krait Mkii Corrosive 2") },
{ "decal_playergroup_diamond_frogs", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Decal Playergroup Diamond Frogs") },
{ "paintjob_krait_light_iridescenthighcolour_04", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Krait Light Iridescent highcolour 4") },
{ "paintjob_python_tactical_blue", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Python Tactical Blue") },
{ "paintjob_asp_scout_lrpo_azure", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Asp Scout Lrpo Azure") },
{ "decal_exploration_emissblue", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Decal Exploration Emissblue") },
{ "paintjob_krait_light_egypt_02", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Krait Light Egypt 2") },
{ "paintjob_asp_vibrant_yellow", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Asp Vibrant Yellow") },
{ "sidewinder_shipkit1_bumper3", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Sidewinder Shipkit 1 Bumper 3") },
{ "paintjob_asp_default_03", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Asp Default 3") },
...
{ "paintjob_mamba_vibrant_red", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Mamba Vibrant Red") },
...
{ "paintjob_diamondback_squadron_gold", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Diamondback Squadron Gold") },
...
{ "paintjob_typex_2_metallic2_chrome", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Typex 2 Metallic 2 Chrome") },
{ "paintjob_typex_3_metallic2_chrome", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Typex 3 Metallic 2 Chrome") },
{ "paintjob_krait_mkii_tactical_grey", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paint Job Krait Mk II Tactical Grey") },
{ "paintjob_type9_military_militaire_dark_green", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Type 9 Military Militaire Dark Green") },
{ "paintjob_empire_eagle_vibrant_red", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Empire Eagle Vibrant Red") },
{ "paintjob_testbuggy_vibrant_red", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob SRV Vibrant Red") },
{ "paintjob_federation_corvette_iridescenthighcolour_04", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Federation Corvette Iridescent highcolour 4") },
{ "paintjob_krait_mkii_corrosive_03", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Krait Mkii Corrosive 3") },
{ "paintjob_hauler_tactical_white", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Hauler Tactical White") },
{ "paintjob_diamondback_metallic2_chrome", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Diamondback Metallic 2 Chrome") },
{ "paintjob_mamba_iridescenthighcolour_04", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Mamba Iridescent highcolour 4") },
{ "paintjob_krait_light_vibrant_red", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Krait Light Vibrant Red") },
...
{ "paintjob_diamondback_metallic2_gold", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Diamondback Metallic 2 Gold") },
{ "paintjob_viper_razormetal_silver", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Viper Razormetal Silver") },
...
{ "paintjob_viper_mkiv_metallic2_gold", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Viper Mkiv Metallic 2 Gold") },
{ "paintjob_vulture_metallic2_chrome", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Vulture Metallic 2 Chrome") },
...
{ "paintjob_ferdelance_razormetal_silver", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Ferdelance Razormetal Silver") },
{ "paintjob_mamba_iridescenthighcolour_03", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Mamba Iridescent highcolour 3") },
{ "paintjob_type9_vibrant_yellow", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Type 9 Vibrant Yellow") },
{ "paintjob_dolphin_taxi_01", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Dolphin Taxi 1") },
...
{ "paintjob_empire_eagle_egypt_02", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Empire Eagle Egypt 2") },
{ "paintjob_typex_metallic2_chrome", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Typex Metallic 2 Chrome") },
{ "paintjob_eagle_hotrod_01", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Eagle Hotrod 1") },
...
{ "paintjob_cobramkiii_metallic2_gold", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Cobramkiii Metallic 2 Gold") },
{ "paintjob_krait_mkii_squadron_gold", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Krait Mkii Squadron Gold") },
{ "paintjob_federation_gunship_tactical_green", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Federation Gunship Tactical Green") },
{ "paintjob_orca_tactical_grey", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Orca Tactical Grey") },
...
{ "paintjob_dolphin_taxi_02", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Dolphin Taxi 2") },
{ "paintjob_diamondbackxl_metallic2_gold", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Diamondbackxl Metallic 2 Gold") },
{ "paintjob_krait_mkii_corrosive_04", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Krait Mkii Corrosive 4") },
{ "paintjob_typex_iridescentblack_05", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Typex Iridescent black 5") },
{ "paintjob_federation_corvette_summer1_01", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Federation Corvette Summer 1 1") },
{ "paintjob_typex_horus1_01", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Typex Horus 1 1") },
...
{ "paintjob_eagle_iridescentblack_05", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Eagle Iridescent black 5") },
{ "paintjob_cobramkiii_iridescentblack_05", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Cobramkiii Iridescent black 5") },
{ "paintjob_cobramkiii_metallic2_chrome", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Cobramkiii Metallic 2 Chrome") },
{ "paintjob_diamondbackxl_vibrant_green", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Diamondbackxl Vibrant Green") },
...
{ "paintjob_independant_trader_tactical_grey", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Independant Trader Tactical Grey") },
{ "paintjob_vulture_metallic2_gold", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Vulture Metallic 2 Gold") },
{ "vulture_shipkit1_tail3", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Vulture Shipkit 1 Tail 3") },
{ "paintjob_empiretrader_vibrant_yellow", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Empire trader Vibrant Yellow") },
{ "paintjob_orca_metallic2_chrome", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Orca Metallic 2 Chrome") },
{ "paintjob_diamondbackxl_horus1_03", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Diamondbackxl Horus 1 3") },
{ "paintjob_sidewinder_tactical_white", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Sidewinder Tactical White") },
{ "paintjob_dolphin_tactical_white", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Dolphin Tactical White") },
...
{ "paintjob_ferdelance_razormetal_bronze", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Ferdelance Razormetal Bronze") },
...
{ "paintjob_belugaliner_ember_red", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Belugaliner Ember Red") },
...
{ "paintjob_diamondbackxl_vibrant_yellow", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Diamondbackxl Vibrant Yellow") },
...
{ "paintjob_viper_tactical_grey", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Paintjob Viper Tactical Grey") },
