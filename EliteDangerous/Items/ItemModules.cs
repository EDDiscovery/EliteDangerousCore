...
namespace EliteDangerousCore
{
    public partial class ItemData
    {
        ...
        public static Dictionary<string, ShipModule> shipmodules = new Dictionary<string, ShipModule>
        {
            ...
            { "int_hyperdrive_overcharge_size2_class1", new ShipModule(129030577, 2.5, 0.2, "", "Hyperdrive Overcharge Class 2 Rating E", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size2_class2", new ShipModule(129030578, 2.5, 0.25, "", "Hyperdrive Overcharge Class 2 Rating D", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size2_class3", new ShipModule(129030487,2.5,0.25,"OptMass: 60t, SpeedIncrease: 142%, AccelerationRate: 0.09, HeatGenerationRate: 0.41, ControlInterference: 0.24","Hyperdrive Overcharged Class 2 Rating C",ShipModule.ModuleTypes.FrameShiftDrive) },
            { "int_hyperdrive_overcharge_size2_class4", new ShipModule(129030579, 2.5, 0.25, "", "Hyperdrive Overcharge Class 2 Rating B", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size2_class5", new ShipModule(129030580, 2.5, 0.3, "", "Hyperdrive Overcharge Class 2 Rating A", ShipModule.ModuleTypes.FrameShiftDrive ) },

            { "int_hyperdrive_overcharge_size3_class1", new ShipModule(129030581, 5, 0.3, "", "Hyperdrive Overcharge Class 3 Rating E", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size3_class2", new ShipModule(129030582, 2, 0.38, "", "Hyperdrive Overcharge Class 3 Rating D", ShipModule.ModuleTypes.FrameShiftDrive ) },
            ...
            { "int_hyperdrive_overcharge_size3_class3", new ShipModule(129030486,5,0.38,"OptMass: 100t, SpeedIncrease: 120%, AccelerationRate: 0.07, HeatGenerationRate: 0.49, ControlInterference: 0.29","Hyperdrive Overcharged Class 3 Rating C",ShipModule.ModuleTypes.FrameShiftDrive) },
            { "int_hyperdrive_overcharge_size3_class5", new ShipModule(129030584, 5, 0.45, "", "Hyperdrive Overcharge Class 3 Rating A", ShipModule.ModuleTypes.FrameShiftDrive ) },

            { "int_hyperdrive_overcharge_size4_class1", new ShipModule(129030585, 10, 0.3, "", "Hyperdrive Overcharge Class 4 Rating E", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size4_class2", new ShipModule(129030586, 4, 0.38, "", "Hyperdrive Overcharge Class 4 Rating D", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size4_class3", new ShipModule(129030485,10,0.38,"OptMass: 350t, SpeedIncrease: 100%, AccelerationRate: 0.06, HeatGenerationRate: 1.23, ControlInterference: 0.35","Hyperdrive Overcharged Class 4 Rating C",ShipModule.ModuleTypes.FrameShiftDrive) },
            { "int_hyperdrive_overcharge_size4_class4", new ShipModule(129030587, 10, 0.38, "", "Hyperdrive Overcharge Class 4 Rating B", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size4_class5", new ShipModule(129030588, 10, 0.45, "", "Hyperdrive Overcharge Class 4 Rating A", ShipModule.ModuleTypes.FrameShiftDrive ) },

            { "int_hyperdrive_overcharge_size5_class1", new ShipModule(129030589, 20, 0.45, "", "Hyperdrive Overcharge Class 5 Rating E", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size5_class2", new ShipModule(129030590, 8, 0.5, "", "Hyperdrive Overcharge Class 5 Rating D", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size5_class3", new ShipModule(129030474,20,0.5,"OptMass: 665t, SpeedIncrease: 80%, AccelerationRate: 0.055, HeatGenerationRate: 1.4, ControlInterference: 0.4","Hyperdrive Overcharged Class 5 Rating C",ShipModule.ModuleTypes.FrameShiftDrive) },
            { "int_hyperdrive_overcharge_size5_class4", new ShipModule(129030591, 20, 0.5, "", "Hyperdrive Overcharge Class 5 Rating B", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size5_class5", new ShipModule(129030592, 20, 0.6, "", "Hyperdrive Overcharge Class 5 Rating A", ShipModule.ModuleTypes.FrameShiftDrive ) },

            { "int_hyperdrive_overcharge_size6_class1", new ShipModule(129030593, 40, 0.5, "", "Hyperdrive Overcharge Class 6 Rating E", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size6_class2", new ShipModule(129030594, 16, 0.63, "", "Hyperdrive Overcharge Class 6 Rating D", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size6_class3", new ShipModule(129030484,40,0.63,"OptMass: 1200t, SpeedIncrease: 62%, AccelerationRate: 0.045, HeatGenerationRate: 1.8, ControlInterference: 0.64","Hyperdrive Overcharged Class 6 Rating C",ShipModule.ModuleTypes.FrameShiftDrive) },
            { "int_hyperdrive_overcharge_size6_class4", new ShipModule(129030595, 40, 0.63, "", "Hyperdrive Overcharge Class 6 Rating B", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size6_class5", new ShipModule(129030596, 40, 0.75, "", "Hyperdrive Overcharge Class 6 Rating A", ShipModule.ModuleTypes.FrameShiftDrive ) },

            { "int_hyperdrive_overcharge_size7_class1", new ShipModule(129030597,80, 0.6, "", "Hyperdrive Overcharge Class 7 Rating E", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size7_class2", new ShipModule(129030598, 32, 0.75, "", "Hyperdrive Overcharge Class 7 Rating D", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size7_class3", new ShipModule(129030483,80,0.75,"OptMass: 1710t, SpeedIncrease: 46%, AccelerationRate: 0.04, HeatGenerationRate: 2, ControlInterference: 0.67","Hyperdrive Overcharged Class 7 Rating C",ShipModule.ModuleTypes.FrameShiftDrive) },
            { "int_hyperdrive_overcharge_size7_class4", new ShipModule(129030599, 80, 0.75, "", "Hyperdrive Overcharge Class 7 Rating B", ShipModule.ModuleTypes.FrameShiftDrive ) },
            { "int_hyperdrive_overcharge_size7_class5", new ShipModule(129030600, 80, 0.9, "", "Hyperdrive Overcharge Class 7 Rating A", ShipModule.ModuleTypes.FrameShiftDrive ) },
