    ...
    public partial class ItemData
    {
        ...
        static void CreateModules()
        {
            ...
            vanitymodules = new Dictionary<string, ShipModule>   
            {
                ...
                {"decal_combat_elite03", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Decal Combat Elite 3") },
                {"decal_combat_elite04", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Decal Combat Elite 4") },
                {"decal_combat_elite05", new ShipModule(-1,ShipModule.ModuleTypes.VanityType,"Decal Combat Elite 5") },
