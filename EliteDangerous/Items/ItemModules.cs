    ...
    public partial class ItemData
    {
        ...
        static void CreateModules()
        {
            ...
            shipmodules = new Dictionary<string, ShipModule>
            {
                ...
                { "int_dronecontrol_resourcesiphon", new ShipModule(128066402,ShipModule.ModuleTypes.HatchBreakerLimpetController,"Hatch Breaking Limpet Controller"){ Cost = 18040, Class = 1, Rating = "I", Integrity = 20, PowerDraw = 0.4, BootTime = 0, Limpets = 2, Range = 1000, Time = 60, Speed = 200, HackTime = 5, MinCargo = 1, MaxCargo = 2 } },
