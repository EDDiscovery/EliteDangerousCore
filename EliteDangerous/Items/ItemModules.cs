...
namespace EliteDangerousCore
{
    public partial class ItemData
    {
        ...
        public class ShipModule 
        {
            ...
            [PropertyNameAttribute("%")] public double? ExplosiveResistance { get; set; } //% bonus on base values
            [PropertyNameAttribute("%")] public double? KineticResistance { get; set; } //% bonus on base values
            [PropertyNameAttribute("%")] public double? ThermalResistance { get; set; } //% bonus on base values
            [PropertyNameAttribute("%")] public double? CausticResistance { get; set; } //% bonus on base values not armour
            [PropertyNameAttribute("%")] public double? AXResistance { get; set; } //% bonus on base values armour - not engineered
        ...
        static void CreateModules()
        {
            ...
            shipmodules = new Dictionary<string, ShipModule>
            {
                ...
                { "hpt_beamlaser_fixed_small", new ShipModule(128049428,ShipModule.ModuleTypes.BeamLaser,"Beam Laser Fixed Small"){ Cost = 37430, Mount = "F", Class = 1, Rating = "E", Mass = 2, Integrity = 40, Power = 0.62, BootTime = 0, DPS = 9.82, Damage = 9.82, DistributorDraw = 1.94, ThermL = 3.53, Pierce = 18, Range = 3000, BurstInterval = 0, BreachDamage = 7.9, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 600 } },
                { "hpt_beamlaser_fixed_medium", new ShipModule(128049429,ShipModule.ModuleTypes.BeamLaser,"Beam Laser Fixed Medium"){ Cost = 299520, Mount = "F", Class = 2, Rating = "D", Mass = 4, Integrity = 51, Power = 1.01, BootTime = 0, DPS = 15.96, Damage = 15.96, DistributorDraw = 3.16, ThermL = 5.11, Pierce = 35, Range = 3000, BurstInterval = 0, BreachDamage = 12.8, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 600 } },
                { "hpt_beamlaser_fixed_large", new ShipModule(128049430,ShipModule.ModuleTypes.BeamLaser,"Beam Laser Fixed Large"){ Cost = 1177600, Mount = "F", Class = 3, Rating = "C", Mass = 8, Integrity = 64, Power = 1.62, BootTime = 0, DPS = 25.78, Damage = 25.78, DistributorDraw = 5.1, ThermL = 7.22, Pierce = 50, Range = 3000, BurstInterval = 0, BreachDamage = 20.6, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 600 } },
                { "hpt_beamlaser_fixed_huge", new ShipModule(128049431,ShipModule.ModuleTypes.BeamLaser,"Beam Laser Fixed Huge"){ Cost = 2396160, Mount = "F", Class = 4, Rating = "A", Mass = 16, Integrity = 80, Power = 2.61, BootTime = 0, DPS = 41.38, Damage = 41.38, DistributorDraw = 8.19, ThermL = 9.93, Pierce = 60, Range = 3000, BurstInterval = 0, BreachDamage = 33.1, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 600 } },
                { "hpt_beamlaser_gimbal_small", new ShipModule(128049432,ShipModule.ModuleTypes.BeamLaser,"Beam Laser Gimbal Small"){ Cost = 74650, Mount = "G", Class = 1, Rating = "E", Mass = 2, Integrity = 40, Power = 0.6, BootTime = 0, DPS = 7.68, Damage = 7.68, DistributorDraw = 2.11, ThermL = 3.65, Pierce = 18, Range = 3000, BurstInterval = 0, BreachDamage = 6.1, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 600 } },
                ...
                { "hpt_beamlaser_gimbal_huge", new ShipModule(128681994,ShipModule.ModuleTypes.BeamLaser,"Beam Laser Gimbal Huge"){ Cost = 8746160, Mount = "G", Class = 4, Rating = "A", Mass = 16, Integrity = 80, Power = 2.57, BootTime = 0, DPS = 32.68, Damage = 32.68, DistributorDraw = 8.99, ThermL = 10.62, Pierce = 60, Range = 3000, BurstInterval = 0, BreachDamage = 26.1, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 600 } },

                // burst laser

                { "hpt_pulselaserburst_fixed_small", new ShipModule(128049400,ShipModule.ModuleTypes.BurstLaser,"Burst Laser Fixed Small"){ Cost = 4400, Mount = "F", Class = 1, Rating = "F", Mass = 2, Integrity = 40, Power = 0.65, BootTime = 0, DPS = 8.147, Damage = 1.72, DistributorDraw = 0.25, ThermL = 0.38, Pierce = 20, Range = 3000, RateOfFire = 4.737, BurstInterval = 0.5, BurstRateOfFire = 15, BurstSize = 3, BreachDamage = 1.5, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, KineticProportionDamage = 0, Falloff = 500 } },
                { "hpt_pulselaserburst_fixed_medium", new ShipModule(128049401,ShipModule.ModuleTypes.BurstLaser,"Burst Laser Fixed Medium"){ Cost = 23000, Mount = "F", Class = 2, Rating = "E", Mass = 4, Integrity = 40, Power = 1.05, BootTime = 0, DPS = 13.045, Damage = 3.53, DistributorDraw = 0.5, ThermL = 0.78, Pierce = 35, Range = 3000, RateOfFire = 3.695, BurstInterval = 0.63, BurstRateOfFire = 11, BurstSize = 3, BreachDamage = 3, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, KineticProportionDamage = 0, Falloff = 500 } },
                ...
                { "hpt_pulselaserburst_fixed_huge", new ShipModule(128049403,ShipModule.ModuleTypes.BurstLaser,"Burst Laser Fixed Huge"){ Cost = 281600, Mount = "F", Class = 4, Rating = "E", Mass = 16, Integrity = 80, Power = 2.58, BootTime = 0, DPS = 32.259, Damage = 20.61, DistributorDraw = 2.98, ThermL = 4.53, Pierce = 65, Range = 3000, RateOfFire = 1.565, BurstInterval = 1.25, BurstRateOfFire = 3, BurstSize = 3, BreachDamage = 17.5, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, KineticProportionDamage = 0, Falloff = 500 } },
                { "hpt_pulselaserburst_gimbal_small", new ShipModule(128049404,ShipModule.ModuleTypes.BurstLaser,"Burst Laser Gimbal Small"){ Cost = 8600, Mount = "G", Class = 1, Rating = "G", Mass = 2, Integrity = 40, Power = 0.64, BootTime = 0, DPS = 6.448, Damage = 1.22, DistributorDraw = 0.24, ThermL = 0.34, Pierce = 20, Range = 3000, RateOfFire = 5.285, BurstInterval = 0.45, BurstRateOfFire = 17, BurstSize = 3, BreachDamage = 1, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, KineticProportionDamage = 0, Falloff = 500 } },
                ...
                { "hpt_pulselaserburst_gimbal_large", new ShipModule(128049406,ShipModule.ModuleTypes.BurstLaser,"Burst Laser Gimbal Large"){ Cost = 281600, Mount = "G", Class = 3, Rating = "E", Mass = 8, Integrity = 64, Power = 1.65, BootTime = 0, DPS = 16.605, Damage = 5.16, DistributorDraw = 1.03, ThermL = 1.42, Pierce = 52, Range = 3000, RateOfFire = 3.218, BurstInterval = 0.71, BurstRateOfFire = 9, BurstSize = 3, BreachDamage = 4.4, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, KineticProportionDamage = 0, Falloff = 500 } },
                { "hpt_pulselaserburst_turret_small", new ShipModule(128049407,ShipModule.ModuleTypes.BurstLaser,"Burst Laser Turret Small"){ Cost = 52800, Mount = "T", Class = 1, Rating = "G", Mass = 2, Integrity = 40, Power = 0.6, BootTime = 0, DPS = 4.174, Damage = 0.87, DistributorDraw = 0.139, ThermL = 0.19, Pierce = 20, Range = 3000, RateOfFire = 4.798, BurstInterval = 0.52, BurstRateOfFire = 19, BurstSize = 3, BreachDamage = 0.4, BreachMin = 60, BreachMax = 80, ThermalProportionDamage = 100, KineticProportionDamage = 0, Falloff = 500 } },
                ...
                { "hpt_pulselaserburst_gimbal_huge", new ShipModule(128727920,ShipModule.ModuleTypes.BurstLaser,"Burst Laser Gimbal Huge"){ Cost = 1245600, Mount = "G", Class = 4, Rating = "E", Mass = 16, Integrity = 64, Power = 2.59, BootTime = 0, DPS = 25.907, Damage = 12.09, DistributorDraw = 2.41, ThermL = 3.33, Pierce = 65, Range = 3000, RateOfFire = 2.143, BurstInterval = 1, BurstRateOfFire = 5, BurstSize = 3, BreachDamage = 10.3, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, KineticProportionDamage = 0, Falloff = 500 } },
                ...
                { "hpt_cannon_fixed_small", new ShipModule(128049438,ShipModule.ModuleTypes.Cannon,"Cannon Fixed Small"){ Cost = 21100, Mount = "F", Class = 1, Rating = "D", Mass = 2, Integrity = 40, Power = 0.34, BootTime = 0, DPS = 11.25, Damage = 22.5, DistributorDraw = 0.46, ThermL = 1.38, Pierce = 35, Range = 3000, Speed = 1200, RateOfFire = 0.5, BurstInterval = 2, Clip = 6, Ammo = 120, ReloadTime = 3, BreachDamage = 21.4, BreachMin = 60, BreachMax = 90, KineticProportionDamage = 100, ExplosiveProportionDamage = 0, Falloff = 3000, AmmoCost = 20 } },
                { "hpt_cannon_fixed_medium", new ShipModule(128049439,ShipModule.ModuleTypes.Cannon,"Cannon Fixed Medium"){ Cost = 168430, Mount = "F", Class = 2, Rating = "D", Mass = 4, Integrity = 51, Power = 0.49, BootTime = 0, DPS = 16.993, Damage = 36.875, DistributorDraw = 0.7, ThermL = 2.11, Pierce = 50, Range = 3500, Speed = 1051.051, RateOfFire = 0.461, BurstInterval = 2.17, Clip = 6, Ammo = 120, ReloadTime = 3, BreachDamage = 35, BreachMin = 60, BreachMax = 90, KineticProportionDamage = 100, ExplosiveProportionDamage = 0, Falloff = 3500, AmmoCost = 20 } },
                { "hpt_cannon_fixed_large", new ShipModule(128049440,ShipModule.ModuleTypes.Cannon,"Cannon Fixed Large"){ Cost = 675200, Mount = "F", Class = 3, Rating = "C", Mass = 8, Integrity = 64, Power = 0.67, BootTime = 0, DPS = 23.372, Damage = 55.625, DistributorDraw = 1.07, ThermL = 3.2, Pierce = 70, Range = 4000, Speed = 959.233, RateOfFire = 0.42, BurstInterval = 2.38, Clip = 6, Ammo = 120, ReloadTime = 3, BreachDamage = 52.8, BreachMin = 60, BreachMax = 90, KineticProportionDamage = 100, ExplosiveProportionDamage = 0, Falloff = 4000, AmmoCost = 20 } },
                ...
                { "hpt_cannon_gimbal_small", new ShipModule(128049442,ShipModule.ModuleTypes.Cannon,"Cannon Gimbal Small"){ Cost = 42200, Mount = "G", Class = 1, Rating = "E", Mass = 2, Integrity = 40, Power = 0.38, BootTime = 0, DPS = 8.292, Damage = 15.92, DistributorDraw = 0.48, ThermL = 1.25, Pierce = 35, Range = 3000, Speed = 1000, RateOfFire = 0.521, BurstInterval = 1.92, Clip = 5, Ammo = 100, ReloadTime = 4, BreachDamage = 15.1, BreachMin = 60, BreachMax = 90, KineticProportionDamage = 100, ExplosiveProportionDamage = 0, Falloff = 3000, AmmoCost = 20 } },
                { "hpt_cannon_gimbal_medium", new ShipModule(128049443,ShipModule.ModuleTypes.Cannon,"Cannon Gimbal Medium"){ Cost = 337600, Mount = "G", Class = 2, Rating = "D", Mass = 4, Integrity = 51, Power = 0.54, BootTime = 0, DPS = 12.274, Damage = 25.53, DistributorDraw = 0.75, ThermL = 1.92, Pierce = 50, Range = 3500, Speed = 875, RateOfFire = 0.481, BurstInterval = 2.08, Clip = 5, Ammo = 100, ReloadTime = 4, BreachDamage = 24.3, BreachMin = 60, BreachMax = 90, KineticProportionDamage = 100, ExplosiveProportionDamage = 0, Falloff = 3500, AmmoCost = 20 } },
                ...
                { "hpt_cannon_turret_small", new ShipModule(128049445,ShipModule.ModuleTypes.Cannon,"Cannon Turret Small"){ Cost = 506400, Mount = "T", Class = 1, Rating = "F", Mass = 2, Integrity = 40, Power = 0.32, BootTime = 0, DPS = 5.528, Damage = 12.77, DistributorDraw = 0.22, ThermL = 0.67, Pierce = 35, Range = 3000, Speed = 1000, RateOfFire = 0.433, BurstInterval = 2.31, Clip = 5, Ammo = 100, ReloadTime = 4, BreachDamage = 12.1, BreachMin = 60, BreachMax = 90, KineticProportionDamage = 100, ExplosiveProportionDamage = 0, Falloff = 3000, AmmoCost = 20 } },
                { "hpt_cannon_turret_medium", new ShipModule(128049446,ShipModule.ModuleTypes.Cannon,"Cannon Turret Medium"){ Cost = 4051200, Mount = "T", Class = 2, Rating = "E", Mass = 4, Integrity = 51, Power = 0.45, BootTime = 0, DPS = 7.916, Damage = 19.79, DistributorDraw = 0.34, ThermL = 1.03, Pierce = 50, Range = 3500, Speed = 875, RateOfFire = 0.4, BurstInterval = 2.5, Clip = 5, Ammo = 100, ReloadTime = 4, BreachDamage = 18.8, BreachMin = 60, BreachMax = 90, KineticProportionDamage = 100, ExplosiveProportionDamage = 0, Falloff = 3500, AmmoCost = 20 } },
                ...
                { "hpt_slugshot_fixed_small", new ShipModule(128049448,ShipModule.ModuleTypes.FragmentCannon,"Fragment Cannon Fixed Small"){ Cost = 36000, Mount = "F", Class = 1, Rating = "E", Mass = 2, Integrity = 40, Power = 0.45, BootTime = 0, DPS = 95.333, Damage = 1.43, DistributorDraw = 0.21, ThermL = 0.41, Pierce = 20, Range = 2000, Speed = 667, RateOfFire = 5.556, BurstInterval = 0.18, Clip = 3, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 1.3, BreachMin = 40, BreachMax = 80, Jitter = 5, KineticProportionDamage = 100, ThermalProportionDamage = 0, Falloff = 1800, AmmoCost = 17 } },
                ...
                { "hpt_slugshot_turret_small", new ShipModule(128049453,ShipModule.ModuleTypes.FragmentCannon,"Fragment Cannon Turret Small"){ Cost = 182400, Mount = "T", Class = 1, Rating = "E", Mass = 2, Integrity = 40, Power = 0.42, BootTime = 0, DPS = 39.429, Damage = 0.69, DistributorDraw = 0.1, ThermL = 0.2, Pierce = 20, Range = 2000, Speed = 667, RateOfFire = 4.762, BurstInterval = 0.21, Clip = 3, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 0.6, BreachMin = 40, BreachMax = 80, Jitter = 5, KineticProportionDamage = 100, ThermalProportionDamage = 0, Falloff = 1800, AmmoCost = 17 } },
                { "hpt_slugshot_turret_medium", new ShipModule(128049454,ShipModule.ModuleTypes.FragmentCannon,"Fragment Cannon Turret Medium"){ Cost = 1459200, Mount = "T", Class = 2, Rating = "D", Mass = 4, Integrity = 51, Power = 0.79, BootTime = 0, DPS = 87.13, Damage = 1.67, DistributorDraw = 0.21, ThermL = 0.41, Pierce = 30, Range = 2000, Speed = 667, RateOfFire = 4.348, BurstInterval = 0.23, Clip = 3, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 1.5, BreachMin = 40, BreachMax = 80, Jitter = 5, KineticProportionDamage = 100, ThermalProportionDamage = 0, Falloff = 1800, AmmoCost = 17 } },

                { "hpt_slugshot_gimbal_large", new ShipModule(128671321,ShipModule.ModuleTypes.FragmentCannon,"Fragment Cannon Gimbal Large"){ Cost = 1751040, Mount = "G", Class = 3, Rating = "C", Mass = 8, Integrity = 64, Power = 1.55, BootTime = 0, DPS = 215.429, Damage = 3.77, DistributorDraw = 0.81, ThermL = 1.4, Pierce = 45, Range = 2000, Speed = 667, RateOfFire = 4.762, BurstInterval = 0.21, Clip = 3, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 3.4, BreachMin = 40, BreachMax = 80, Jitter = 5, KineticProportionDamage = 100, ThermalProportionDamage = 0, Falloff = 1800, AmmoCost = 17 } },
                ...
                { "hpt_guardian_plasmalauncher_turret_small", new ShipModule(128891606,ShipModule.ModuleTypes.GuardianPlasmaCharger,"Guardian Plasma Charger Turret Small"){ Cost = 484050, Mount = "T", Class = 1, Rating = "F", Mass = 2, Integrity = 34, Power = 1.6, BootTime = 0, DPS = 10, Damage = 2, Time = 1.8, DamageMultiplierFullCharge = 17, DistributorDraw = 0.8, ThermL = 5.01, Pierce = 65, Range = 3000, Speed = 1200, RateOfFire = 5, BurstInterval = 0.2, Clip = 15, Ammo = 200, ReloadTime = 3, BreachDamage = 0.5, BreachMin = 50, BreachMax = 80, AbsoluteProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1000, AmmoCost = 100 } },
                ...
                { "hpt_guardian_shardcannon_turret_small", new ShipModule(128891608,ShipModule.ModuleTypes.GuardianShardCannon,"Guardian Shard Cannon Turret Small"){ Cost = 502000, Mount = "T", Class = 1, Rating = "F", Mass = 2, Integrity = 34, Power = 0.72, BootTime = 0, DPS = 40.4, Damage = 2.02, DistributorDraw = 0.36, ThermL = 0.58, Pierce = 30, Range = 1700, Speed = 1133, RateOfFire = 1.667, BurstInterval = 0.6, Clip = 5, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 1.6, BreachMin = 60, BreachMax = 80, Jitter = 5, ThermalProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1700, AmmoCost = 9 } },
                ...
                { "hpt_guardian_gausscannon_fixed_small", new ShipModule(128891610,ShipModule.ModuleTypes.GuardianGaussCannon,"Guardian Gauss Cannon Fixed Small"){ Cost = 167250, Mount = "F", Class = 1, Rating = "D", Mass = 2, Integrity = 40, Power = 1.91, BootTime = 0, DPS = 48.193, Damage = 40, DistributorDraw = 3.8, ThermL = 15, Pierce = 140, Range = 3000, Time = 1.2, RateOfFire = 1.205, BurstInterval = 0.83, Clip = 1, Ammo = 80, ReloadTime = 1, BreachDamage = 20, BreachMin = 20, BreachMax = 40, ThermalProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1500, AmmoCost = 75 } },

                { "hpt_guardian_gausscannon_fixed_medium", new ShipModule(128833687,ShipModule.ModuleTypes.GuardianGaussCannon,"Guardian Gauss Cannon Fixed Medium"){ Cost = 543800, Mount = "F", Class = 2, Rating = "B", Mass = 4, Integrity = 42, Power = 2.61, BootTime = 0, DPS = 84.337, Damage = 70, DistributorDraw = 7.2, ThermL = 25, Pierce = 140, Range = 3000, Time = 1.2, RateOfFire = 1.205, BurstInterval = 0.83, Clip = 1, Ammo = 80, ReloadTime = 1, BreachDamage = 35, BreachMin = 20, BreachMax = 40, ThermalProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1500, AmmoCost = 75 } },

                { "hpt_guardian_plasmalauncher_fixed_medium", new ShipModule(128833998,ShipModule.ModuleTypes.GuardianPlasmaCharger,"Guardian Plasma Charger Fixed Medium"){ Cost = 567760, Mount = "F", Class = 2, Rating = "B", Mass = 4, Integrity = 42, Power = 2.13, BootTime = 0, DPS = 25, Damage = 5, Time = 1.8, DamageMultiplierFullCharge = 17, DistributorDraw = 1.25, ThermL = 5.21, Pierce = 80, Range = 3000, Speed = 1200, RateOfFire = 5, BurstInterval = 0.2, Clip = 15, Ammo = 200, ReloadTime = 3, BreachDamage = 1.25, BreachMin = 50, BreachMax = 80, AbsoluteProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1000, AmmoCost = 100 } },
                { "hpt_guardian_plasmalauncher_turret_medium", new ShipModule(128833999,ShipModule.ModuleTypes.GuardianPlasmaCharger,"Guardian Plasma Charger Turret Medium"){ Cost = 1659200, Mount = "T", Class = 2, Rating = "E", Mass = 4, Integrity = 42, Power = 2.01, BootTime = 0, DPS = 20, Damage = 4, Time = 1.8, DamageMultiplierFullCharge = 17, DistributorDraw = 1.4, ThermL = 5.8, Pierce = 80, Range = 3000, Speed = 1200, RateOfFire = 5, BurstInterval = 0.2, Clip = 15, Ammo = 200, ReloadTime = 3, BreachDamage = 1, BreachMin = 50, BreachMax = 80, AbsoluteProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1000, AmmoCost = 100 } },
                { "hpt_guardian_shardcannon_fixed_medium", new ShipModule(128834000,ShipModule.ModuleTypes.GuardianShardCannon,"Guardian Shard Cannon Fixed Medium"){ Cost = 507760, Mount = "F", Class = 2, Rating = "A", Mass = 4, Integrity = 42, Power = 1.21, BootTime = 0, DPS = 135.4, Damage = 6.77, DistributorDraw = 0.65, ThermL = 1.2, Pierce = 45, Range = 1700, Speed = 1133, RateOfFire = 1.667, BurstInterval = 0.6, Clip = 5, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 5.4, BreachMin = 60, BreachMax = 80, Jitter = 5, ThermalProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1700, AmmoCost = 9 } },
                { "hpt_guardian_shardcannon_turret_medium", new ShipModule(128834001,ShipModule.ModuleTypes.GuardianShardCannon,"Guardian Shard Cannon Turret Medium"){ Cost = 1767000, Mount = "T", Class = 2, Rating = "A", Mass = 4, Integrity = 42, Power = 1.16, BootTime = 0, DPS = 86.8, Damage = 4.34, DistributorDraw = 0.57, ThermL = 1.09, Pierce = 45, Range = 1700, Speed = 1133, RateOfFire = 1.667, BurstInterval = 0.6, Clip = 5, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 3.5, BreachMin = 60, BreachMax = 80, Jitter = 5, ThermalProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1700, AmmoCost = 9 } },

                { "hpt_guardian_plasmalauncher_fixed_large", new ShipModule(128834783,ShipModule.ModuleTypes.GuardianPlasmaCharger,"Guardian Plasma Charger Fixed Large"){ Cost = 1423300, Mount = "F", Class = 3, Rating = "C", Mass = 8, Integrity = 51, Power = 3.1, BootTime = 0, DPS = 35, Damage = 7, Time = 1.8, DamageMultiplierFullCharge = 17, DistributorDraw = 2.42, ThermL = 6.15, Pierce = 95, Range = 3000, Speed = 1200, RateOfFire = 5, BurstInterval = 0.2, Clip = 15, Ammo = 200, ReloadTime = 3, BreachDamage = 1.75, BreachMin = 50, BreachMax = 80, AbsoluteProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1000, AmmoCost = 100 } },
                { "hpt_guardian_plasmalauncher_turret_large", new ShipModule(128834784,ShipModule.ModuleTypes.GuardianPlasmaCharger,"Guardian Plasma Charger Turret Large"){ Cost = 5495200, Mount = "T", Class = 3, Rating = "D", Mass = 8, Integrity = 51, Power = 2.53, BootTime = 0, DPS = 30, Damage = 6, Time = 1.8, DamageMultiplierFullCharge = 17, DistributorDraw = 2.6, ThermL = 6.4, Pierce = 95, Range = 3000, Speed = 1200, RateOfFire = 5, BurstInterval = 0.2, Clip = 15, Ammo = 200, ReloadTime = 3, BreachDamage = 1.5, BreachMin = 50, BreachMax = 80, AbsoluteProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1000, AmmoCost = 100 } },

                { "hpt_guardian_shardcannon_fixed_large", new ShipModule(128834778,ShipModule.ModuleTypes.GuardianShardCannon,"Guardian Shard Cannon Fixed Large"){ Cost = 1461350, Mount = "F", Class = 3, Rating = "C", Mass = 8, Integrity = 51, Power = 1.68, BootTime = 0, DPS = 190, Damage = 9.5, DistributorDraw = 1.4, ThermL = 2.2, Pierce = 60, Range = 1700, Speed = 1133, RateOfFire = 1.667, BurstInterval = 0.6, Clip = 5, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 7.6, BreachMin = 60, BreachMax = 80, Jitter = 5, ThermalProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1700, AmmoCost = 9 } },
                { "hpt_guardian_shardcannon_turret_large", new ShipModule(128834779,ShipModule.ModuleTypes.GuardianShardCannon,"Guardian Shard Cannon Turret Large"){ Cost = 5865030, Mount = "T", Class = 3, Rating = "D", Mass = 8, Integrity = 51, Power = 1.39, BootTime = 0, DPS = 124, Damage = 6.2, DistributorDraw = 1.2, ThermL = 1.98, Pierce = 60, Range = 1700, Speed = 1133, RateOfFire = 1.667, BurstInterval = 0.6, Clip = 5, Ammo = 180, Rounds = 12, ReloadTime = 5, BreachDamage = 5, BreachMin = 60, BreachMax = 80, Jitter = 5, ThermalProportionDamage = 50, AXPorportionDamage = 50, Falloff = 1700, AmmoCost = 9 } },
                ...
                { "int_guardianshieldreinforcement_size1_class1", new ShipModule(128833965,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 1 Rating E"){ Cost = 10000, Class = 1, Rating = "E", Mass = 2, Integrity = 36, Power = 0.35, AdditionalReinforcement = 44 } },
                { "int_guardianshieldreinforcement_size1_class2", new ShipModule(128833966,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 1 Rating D"){ Cost = 30000, Class = 1, Rating = "D", Mass = 1, Integrity = 36, Power = 0.46, AdditionalReinforcement = 61 } },
                { "int_guardianshieldreinforcement_size2_class1", new ShipModule(128833967,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 2 Rating E"){ Cost = 24000, Class = 2, Rating = "E", Mass = 4, Integrity = 36, Power = 0.56, AdditionalReinforcement = 83 } },
                { "int_guardianshieldreinforcement_size2_class2", new ShipModule(128833968,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 2 Rating D"){ Cost = 72000, Class = 2, Rating = "D", Mass = 2, Integrity = 36, Power = 0.67, AdditionalReinforcement = 105 } },
                { "int_guardianshieldreinforcement_size3_class1", new ShipModule(128833969,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 3 Rating E"){ Cost = 57600, Class = 3, Rating = "E", Mass = 8, Integrity = 36, Power = 0.74, AdditionalReinforcement = 127 } },
                { "int_guardianshieldreinforcement_size3_class2", new ShipModule(128833970,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 3 Rating D"){ Cost = 172800, Class = 3, Rating = "D", Mass = 4, Integrity = 36, Power = 0.84, AdditionalReinforcement = 143 } },
                { "int_guardianshieldreinforcement_size4_class1", new ShipModule(128833971,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 4 Rating E"){ Cost = 138240, Class = 4, Rating = "E", Mass = 16, Integrity = 36, Power = 0.95, AdditionalReinforcement = 165 } },
                { "int_guardianshieldreinforcement_size4_class2", new ShipModule(128833972,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 4 Rating D"){ Cost = 414720, Class = 4, Rating = "D", Mass = 8, Integrity = 36, Power = 1.05, AdditionalReinforcement = 182 } },
                { "int_guardianshieldreinforcement_size5_class1", new ShipModule(128833973,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 5 Rating E"){ Cost = 331780, Class = 5, Rating = "E", Mass = 32, Integrity = 36, Power = 1.16, AdditionalReinforcement = 198 } },
                { "int_guardianshieldreinforcement_size5_class2", new ShipModule(128833974,ShipModule.ModuleTypes.GuardianShieldReinforcement,"Guardian Shield Reinforcement Package Class 5 Rating D"){ Cost = 995330, Class = 5, Rating = "D", Mass = 16, Integrity = 36, Power = 1.26, AdditionalReinforcement = 215 } },
                ...
                { "int_guardianpowerdistributor_size1", new ShipModule(128833980,ShipModule.ModuleTypes.GuardianHybridPowerDistributor,"Guardian Hybrid Power Distributor Class 1"){ Cost = 40960, Class = 1, Rating = "A", Mass = 1.4, Integrity = 35, Power = 0.62, BootTime = 5, PowerBonus = 4, WeaponsCapacity = 10, WeaponsRechargeRate = 2.5, EngineCapacity = 9, EngineRechargeRate = 0.8, SystemsCapacity = 10, SystemsRechargeRate = 0.8 } },
                { "int_guardianpowerdistributor_size2", new ShipModule(128833981,ShipModule.ModuleTypes.GuardianHybridPowerDistributor,"Guardian Hybrid Power Distributor Class 2"){ Cost = 111600, Class = 2, Rating = "A", Mass = 2.6, Integrity = 45, Power = 0.73, BootTime = 5, PowerBonus = 4, WeaponsCapacity = 13, WeaponsRechargeRate = 3.1, EngineCapacity = 11, EngineRechargeRate = 1, SystemsCapacity = 11, SystemsRechargeRate = 1 } },
                { "int_guardianpowerdistributor_size3", new ShipModule(128833982,ShipModule.ModuleTypes.GuardianHybridPowerDistributor,"Guardian Hybrid Power Distributor Class 3"){ Cost = 311370, Class = 3, Rating = "A", Mass = 5.25, Integrity = 56, Power = 0.78, BootTime = 5, PowerBonus = 4, WeaponsCapacity = 17, WeaponsRechargeRate = 3.9, EngineCapacity = 14, EngineRechargeRate = 1.7, SystemsCapacity = 14, SystemsRechargeRate = 1.7 } },
                { "int_guardianpowerdistributor_size4", new ShipModule(128833983,ShipModule.ModuleTypes.GuardianHybridPowerDistributor,"Guardian Hybrid Power Distributor Class 4"){ Cost = 868710, Class = 4, Rating = "A", Mass = 10.5, Integrity = 70, Power = 0.87, BootTime = 5, PowerBonus = 4, WeaponsCapacity = 22, WeaponsRechargeRate = 4.9, EngineCapacity = 17, EngineRechargeRate = 2.5, SystemsCapacity = 17, SystemsRechargeRate = 2.5 } },
                { "int_guardianpowerdistributor_size5", new ShipModule(128833984,ShipModule.ModuleTypes.GuardianHybridPowerDistributor,"Guardian Hybrid Power Distributor Class 5"){ Cost = 2423690, Class = 5, Rating = "A", Mass = 21, Integrity = 99, Power = 0.96, BootTime = 5, PowerBonus = 4, WeaponsCapacity = 29, WeaponsRechargeRate = 6, EngineCapacity = 22, EngineRechargeRate = 3.3, SystemsCapacity = 22, SystemsRechargeRate = 3.3 } },
                { "int_guardianpowerdistributor_size6", new ShipModule(128833985,ShipModule.ModuleTypes.GuardianHybridPowerDistributor,"Guardian Hybrid Power Distributor Class 6"){ Cost = 6762090, Class = 6, Rating = "A", Mass = 42, Integrity = 99, Power = 1.07, BootTime = 5, PowerBonus = 4, WeaponsCapacity = 35, WeaponsRechargeRate = 7.3, EngineCapacity = 26, EngineRechargeRate = 4.2, SystemsCapacity = 26, SystemsRechargeRate = 4.2 } },
                { "int_guardianpowerdistributor_size7", new ShipModule(128833986,ShipModule.ModuleTypes.GuardianHybridPowerDistributor,"Guardian Hybrid Power Distributor Class 7"){ Cost = 18866230, Class = 7, Rating = "A", Mass = 84, Integrity = 115, Power = 1.16, BootTime = 5, PowerBonus = 4, WeaponsCapacity = 43, WeaponsRechargeRate = 8.5, EngineCapacity = 31, EngineRechargeRate = 5.2, SystemsCapacity = 31, SystemsRechargeRate = 5.2 } },
                { "int_guardianpowerdistributor_size8", new ShipModule(128833987,ShipModule.ModuleTypes.GuardianHybridPowerDistributor,"Guardian Hybrid Power Distributor Class 8"){ Cost = 52636790, Class = 8, Rating = "A", Mass = 168, Integrity = 132, Power = 1.25, BootTime = 5, PowerBonus = 4, WeaponsCapacity = 50, WeaponsRechargeRate = 10.1, EngineCapacity = 36, EngineRechargeRate = 6.2, SystemsCapacity = 36, SystemsRechargeRate = 6.2 } },
                ...
                { "int_guardianhullreinforcement_size1_class2", new ShipModule(128833946,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 1 Rating D"){ Cost = 30000, Class = 1, Rating = "D", Mass = 1, Power = 0.56, HullReinforcement = 138, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size1_class1", new ShipModule(128833945,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 1 Rating E"){ Cost = 10000, Class = 1, Rating = "E", Mass = 2, Power = 0.45, HullReinforcement = 100, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size2_class1", new ShipModule(128833947,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 2 Rating E"){ Cost = 24000, Class = 2, Rating = "E", Mass = 4, Power = 0.68, HullReinforcement = 188, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size2_class2", new ShipModule(128833948,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 2 Rating D"){ Cost = 72000, Class = 2, Rating = "D", Mass = 2, Power = 0.79, HullReinforcement = 238, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size3_class1", new ShipModule(128833949,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 3 Rating E"){ Cost = 57600, Class = 3, Rating = "E", Mass = 8, Power = 0.9, HullReinforcement = 288, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size3_class2", new ShipModule(128833950,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 3 Rating D"){ Cost = 172800, Class = 3, Rating = "D", Mass = 4, Power = 1.01, HullReinforcement = 325, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size4_class1", new ShipModule(128833951,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 4 Rating E"){ Cost = 138240, Class = 4, Rating = "E", Mass = 16, Power = 1.13, HullReinforcement = 375, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size4_class2", new ShipModule(128833952,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 4 Rating D"){ Cost = 414720, Class = 4, Rating = "D", Mass = 8, Power = 1.24, HullReinforcement = 413, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size5_class1", new ShipModule(128833953,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 5 Rating E"){ Cost = 331780, Class = 5, Rating = "E", Mass = 32, Power = 1.35, HullReinforcement = 450, ThermalResistance = 2, CausticResistance = 5 } },
                { "int_guardianhullreinforcement_size5_class2", new ShipModule(128833954,ShipModule.ModuleTypes.GuardianHullReinforcement,"Guardian Hull Reinforcement Package Class 5 Rating D"){ Cost = 995330, Class = 5, Rating = "D", Mass = 16, Power = 1.46, HullReinforcement = 488, ThermalResistance = 2, CausticResistance = 5 } },
                ...
                { "int_hyperdrive_size2_class4", new ShipModule(128064106,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 2 Rating B"){ Cost = 53410, Class = 2, Rating = "B", Mass = 4, Integrity = 77, Power = 0.25, BootTime = 10, OptMass = 75, ThermL = 10, MaxFuelPerJump = 0.8, LinearConstant = 10, PowerConstant = 2 } },
                { "int_hyperdrive_size2_class5", new ShipModule(128064107,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 2 Rating A"){ Cost = 160220, Class = 2, Rating = "A", Mass = 2.5, Integrity = 64, Power = 0.3, BootTime = 10, OptMass = 90, ThermL = 10, MaxFuelPerJump = 0.9, LinearConstant = 12, PowerConstant = 2 } },
                { "int_hyperdrive_size3_class1", new ShipModule(128064108,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 3 Rating E"){ Cost = 6270, Class = 3, Rating = "E", Mass = 5, Integrity = 58, Power = 0.24, BootTime = 10, OptMass = 80, ThermL = 14, MaxFuelPerJump = 1.2, LinearConstant = 11, PowerConstant = 2.15 } },
                { "int_hyperdrive_size3_class2", new ShipModule(128064109,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 3 Rating D"){ Cost = 18810, Class = 3, Rating = "D", Mass = 2, Integrity = 51, Power = 0.27, BootTime = 10, OptMass = 90, ThermL = 14, MaxFuelPerJump = 1.2, LinearConstant = 10, PowerConstant = 2.15 } },
                { "int_hyperdrive_size3_class3", new ShipModule(128064110,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 3 Rating C"){ Cost = 56440, Class = 3, Rating = "C", Mass = 5, Integrity = 64, Power = 0.3, BootTime = 10, OptMass = 100, ThermL = 14, MaxFuelPerJump = 1.2, LinearConstant = 8, PowerConstant = 2.15 } },
                { "int_hyperdrive_size3_class4", new ShipModule(128064111,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 3 Rating B"){ Cost = 169300, Class = 3, Rating = "B", Mass = 8, Integrity = 96, Power = 0.38, BootTime = 10, OptMass = 125, ThermL = 14, MaxFuelPerJump = 1.5, LinearConstant = 10, PowerConstant = 2.15 } },
                { "int_hyperdrive_size3_class5", new ShipModule(128064112,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 3 Rating A"){ Cost = 507910, Class = 3, Rating = "A", Mass = 5, Integrity = 80, Power = 0.45, BootTime = 10, OptMass = 150, ThermL = 14, MaxFuelPerJump = 1.8, LinearConstant = 12, PowerConstant = 2.15 } },
                { "int_hyperdrive_size4_class1", new ShipModule(128064113,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 4 Rating E"){ Cost = 19880, Class = 4, Rating = "E", Mass = 10, Integrity = 72, Power = 0.24, BootTime = 10, OptMass = 280, ThermL = 18, MaxFuelPerJump = 2, LinearConstant = 11, PowerConstant = 2.3 } },
                { "int_hyperdrive_size4_class2", new ShipModule(128064114,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 4 Rating D"){ Cost = 59630, Class = 4, Rating = "D", Mass = 4, Integrity = 64, Power = 0.27, BootTime = 10, OptMass = 315, ThermL = 18, MaxFuelPerJump = 2, LinearConstant = 10, PowerConstant = 2.3 } },
                { "int_hyperdrive_size4_class3", new ShipModule(128064115,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 4 Rating C"){ Cost = 178900, Class = 4, Rating = "C", Mass = 10, Integrity = 80, Power = 0.3, BootTime = 10, OptMass = 350, ThermL = 18, MaxFuelPerJump = 2, LinearConstant = 8, PowerConstant = 2.3 } },
                { "int_hyperdrive_size4_class4", new ShipModule(128064116,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 4 Rating B"){ Cost = 536690, Class = 4, Rating = "B", Mass = 16, Integrity = 120, Power = 0.38, BootTime = 10, OptMass = 438, ThermL = 18, MaxFuelPerJump = 2.5, LinearConstant = 10, PowerConstant = 2.3 } },
                { "int_hyperdrive_size4_class5", new ShipModule(128064117,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 4 Rating A"){ Cost = 1610080, Class = 4, Rating = "A", Mass = 10, Integrity = 100, Power = 0.45, BootTime = 10, OptMass = 525, ThermL = 18, MaxFuelPerJump = 3, LinearConstant = 12, PowerConstant = 2.3 } },
                { "int_hyperdrive_size5_class1", new ShipModule(128064118,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 5 Rating E"){ Cost = 63010, Class = 5, Rating = "E", Mass = 20, Integrity = 86, Power = 0.32, BootTime = 10, OptMass = 560, ThermL = 27, MaxFuelPerJump = 3.3, LinearConstant = 11, PowerConstant = 2.45 } },
                { "int_hyperdrive_size5_class2", new ShipModule(128064119,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 5 Rating D"){ Cost = 189040, Class = 5, Rating = "D", Mass = 8, Integrity = 77, Power = 0.36, BootTime = 10, OptMass = 630, ThermL = 27, MaxFuelPerJump = 3.3, LinearConstant = 10, PowerConstant = 2.45 } },
                { "int_hyperdrive_size5_class3", new ShipModule(128064120,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 5 Rating C"){ Cost = 567110, Class = 5, Rating = "C", Mass = 20, Integrity = 96, Power = 0.4, BootTime = 10, OptMass = 700, ThermL = 27, MaxFuelPerJump = 3.3, LinearConstant = 8, PowerConstant = 2.45 } },
                { "int_hyperdrive_size5_class4", new ShipModule(128064121,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 5 Rating B"){ Cost = 1701320, Class = 5, Rating = "B", Mass = 32, Integrity = 144, Power = 0.5, BootTime = 10, OptMass = 875, ThermL = 27, MaxFuelPerJump = 4.1, LinearConstant = 10, PowerConstant = 2.45 } },
                { "int_hyperdrive_size5_class5", new ShipModule(128064122,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 5 Rating A"){ Cost = 5103950, Class = 5, Rating = "A", Mass = 20, Integrity = 120, Power = 0.6, BootTime = 10, OptMass = 1050, ThermL = 27, MaxFuelPerJump = 5, LinearConstant = 12, PowerConstant = 2.45 } },
                { "int_hyperdrive_size6_class1", new ShipModule(128064123,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 6 Rating E"){ Cost = 199750, Class = 6, Rating = "E", Mass = 40, Integrity = 102, Power = 0.4, BootTime = 10, OptMass = 960, ThermL = 37, MaxFuelPerJump = 5.3, LinearConstant = 11, PowerConstant = 2.6 } },
                { "int_hyperdrive_size6_class2", new ShipModule(128064124,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 6 Rating D"){ Cost = 599240, Class = 6, Rating = "D", Mass = 16, Integrity = 90, Power = 0.45, BootTime = 10, OptMass = 1080, ThermL = 37, MaxFuelPerJump = 5.3, LinearConstant = 10, PowerConstant = 2.6 } },
                { "int_hyperdrive_size6_class3", new ShipModule(128064125,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 6 Rating C"){ Cost = 1797730, Class = 6, Rating = "C", Mass = 40, Integrity = 113, Power = 0.5, BootTime = 10, OptMass = 1200, ThermL = 37, MaxFuelPerJump = 5.3, LinearConstant = 8, PowerConstant = 2.6 } },
                { "int_hyperdrive_size6_class4", new ShipModule(128064126,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 6 Rating B"){ Cost = 5393180, Class = 6, Rating = "B", Mass = 64, Integrity = 170, Power = 0.63, BootTime = 10, OptMass = 1500, ThermL = 37, MaxFuelPerJump = 6.6, LinearConstant = 10, PowerConstant = 2.6 } },
                { "int_hyperdrive_size6_class5", new ShipModule(128064127,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 6 Rating A"){ Cost = 16179530, Class = 6, Rating = "A", Mass = 40, Integrity = 141, Power = 0.75, BootTime = 10, OptMass = 1800, ThermL = 37, MaxFuelPerJump = 8, LinearConstant = 12, PowerConstant = 2.6 } },
                { "int_hyperdrive_size7_class1", new ShipModule(128064128,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 7 Rating E"){ Cost = 633200, Class = 7, Rating = "E", Mass = 80, Integrity = 118, Power = 0.48, BootTime = 10, OptMass = 1440, ThermL = 43, MaxFuelPerJump = 8.5, LinearConstant = 11, PowerConstant = 2.75 } },
                { "int_hyperdrive_size7_class2", new ShipModule(128064129,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 7 Rating D"){ Cost = 1899600, Class = 7, Rating = "D", Mass = 32, Integrity = 105, Power = 0.54, BootTime = 10, OptMass = 1620, ThermL = 43, MaxFuelPerJump = 8.5, LinearConstant = 10, PowerConstant = 2.75 } },
                { "int_hyperdrive_size7_class3", new ShipModule(128064130,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 7 Rating C"){ Cost = 5698790, Class = 7, Rating = "C", Mass = 80, Integrity = 131, Power = 0.6, BootTime = 10, OptMass = 1800, ThermL = 43, MaxFuelPerJump = 8.5, LinearConstant = 8, PowerConstant = 2.75 } },
                { "int_hyperdrive_size7_class4", new ShipModule(128064131,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 7 Rating B"){ Cost = 17096370, Class = 7, Rating = "B", Mass = 128, Integrity = 197, Power = 0.75, BootTime = 10, OptMass = 2250, ThermL = 43, MaxFuelPerJump = 10.6, LinearConstant = 10, PowerConstant = 2.75 } },
                { "int_hyperdrive_size7_class5", new ShipModule(128064132,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive Class 7 Rating A"){ Cost = 51289110, Class = 7, Rating = "A", Mass = 80, Integrity = 164, Power = 0.9, BootTime = 10, OptMass = 2700, ThermL = 43, MaxFuelPerJump = 12.8, LinearConstant = 12, PowerConstant = 2.75 } },
                ...
                { "int_hyperdrive_overcharge_size2_class1", new ShipModule(129030577,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 2 Rating E"){ Cost = 21360, Class = 2, Rating = "E", Mass = 2.5, Integrity = 51, Power = 0.2, BootTime = 10, OptMass = 60, ThermL = 10, MaxFuelPerJump = 0.6, LinearConstant = 8, PowerConstant = 2, SCOSpeedIncrease = 25, SCOAccelerationRate = 0.08, SCOHeatGenerationRate = 42.07, SCOControlInterference = 0.25 } },
                { "int_hyperdrive_overcharge_size2_class2", new ShipModule(129030578,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 2 Rating D"){ Cost = 64090, Class = 2, Rating = "D", Mass = 2.5, Integrity = 57, Power = 0.25, BootTime = 10, OptMass = 90, ThermL = 10, MaxFuelPerJump = 0.9, LinearConstant = 12, PowerConstant = 2, SCOSpeedIncrease = 142, SCOAccelerationRate = 0.09, SCOHeatGenerationRate = 38, SCOControlInterference = 0.24 } },
                { "int_hyperdrive_overcharge_size2_class3", new ShipModule(129030487,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 2 Rating C"){ Cost = 21360, Class = 2, Rating = "C", Mass = 2.5, Integrity = 57, Power = 0.25, BootTime = 10, OptMass = 90, ThermL = 10, MaxFuelPerJump = 0.9, LinearConstant = 12, PowerConstant = 2, SCOSpeedIncrease = 142, SCOAccelerationRate = 0.09, SCOHeatGenerationRate = 27.14, SCOControlInterference = 0.24 } },
                { "int_hyperdrive_overcharge_size2_class4", new ShipModule(129030579,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 2 Rating B"){ Cost = 64090, Class = 2, Rating = "B", Mass = 2.5, Integrity = 57, Power = 0.25, BootTime = 10, OptMass = 90, ThermL = 10, MaxFuelPerJump = 0.9, LinearConstant = 12, PowerConstant = 2, SCOSpeedIncrease = 142, SCOAccelerationRate = 0.09, SCOHeatGenerationRate = 38, SCOControlInterference = 0.24 } },
                { "int_hyperdrive_overcharge_size2_class5", new ShipModule(129030580,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 2 Rating A"){ Cost = 192270, Class = 2, Rating = "A", Mass = 2.5, Integrity = 64, Power = 0.3, BootTime = 10, OptMass = 100, ThermL = 10, MaxFuelPerJump = 1, LinearConstant = 13, PowerConstant = 2, SCOSpeedIncrease = 160, SCOAccelerationRate = 0.09, SCOHeatGenerationRate = 36.1, SCOControlInterference = 0.23 } },

                { "int_hyperdrive_overcharge_size3_class1", new ShipModule(129030581,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 3 Rating E"){ Cost = 67720, Class = 3, Rating = "E", Mass = 5, Integrity = 64, Power = 0.3, BootTime = 10, OptMass = 100, ThermL = 14, MaxFuelPerJump = 1.2, LinearConstant = 8, PowerConstant = 2.15, SCOSpeedIncrease = 20, SCOAccelerationRate = 0.06, SCOHeatGenerationRate = 58.38, SCOControlInterference = 0.3 } },
                { "int_hyperdrive_overcharge_size3_class2", new ShipModule(129030582,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 3 Rating D"){ Cost = 203170, Class = 3, Rating = "D", Mass = 2, Integrity = 70, Power = 0.38, BootTime = 10, OptMass = 150, ThermL = 14, MaxFuelPerJump = 1.8, LinearConstant = 12, PowerConstant = 2.15, SCOSpeedIncrease = 120, SCOAccelerationRate = 0.07, SCOHeatGenerationRate = 53, SCOControlInterference = 0.29 } },
                ...
                { "int_hyperdrive_overcharge_size3_class3", new ShipModule(129030486,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 3 Rating C"){ Cost = 67720, Class = 3, Rating = "C", Mass = 5, Integrity = 70, Power = 0.38, BootTime = 10, OptMass = 150, ThermL = 14, MaxFuelPerJump = 1.8, LinearConstant = 12, PowerConstant = 2.15, SCOSpeedIncrease = 120, SCOAccelerationRate = 0.07, SCOHeatGenerationRate = 37.86, SCOControlInterference = 0.29 } },
                ...
                { "int_hyperdrive_overcharge_size7_class1", new ShipModule(129030597,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 7 Rating E"){ Cost = 6838550, Class = 7, Rating = "E", Mass = 80, Integrity = 131, Power = 0.6, BootTime = 10, OptMass = 1800, ThermL = 43, MaxFuelPerJump = 8.5, LinearConstant = 8, PowerConstant = 2.75, SCOSpeedIncrease = 0, SCOAccelerationRate = 0.03, SCOHeatGenerationRate = 143.93, SCOControlInterference = 0.67 } },
                { "int_hyperdrive_overcharge_size7_class2", new ShipModule(129030598,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 7 Rating D"){ Cost = 20515650, Class = 7, Rating = "D", Mass = 32, Integrity = 150, Power = 0.75, BootTime = 10, OptMass = 2700, ThermL = 43, MaxFuelPerJump = 12.8, LinearConstant = 12, PowerConstant = 2.75, SCOSpeedIncrease = 46, SCOAccelerationRate = 0.04, SCOHeatGenerationRate = 130, SCOControlInterference = 0.64 } },
                { "int_hyperdrive_overcharge_size7_class3", new ShipModule(129030483,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 7 Rating C"){ Cost = 6838550, Class = 7, Rating = "C", Mass = 80, Integrity = 150, Power = 0.75, BootTime = 10, OptMass = 2700, ThermL = 43, MaxFuelPerJump = 12.8, LinearConstant = 12, PowerConstant = 2.75, SCOSpeedIncrease = 46, SCOAccelerationRate = 0.04, SCOHeatGenerationRate = 92.86, SCOControlInterference = 0.64 } },
                ...
                { "int_hyperdrive_overcharge_size7_class5", new ShipModule(129030600,ShipModule.ModuleTypes.FrameShiftDrive,"Frame Shift Drive (SCO) Class 7 Rating A"){ Cost = 61546940, Class = 7, Rating = "A", Mass = 80, Integrity = 164, Power = 0.9, BootTime = 10, OptMass = 3000, ThermL = 43, MaxFuelPerJump = 13.1, LinearConstant = 13, PowerConstant = 2.75, SCOSpeedIncrease = 58, SCOAccelerationRate = 0.04, SCOHeatGenerationRate = 123.5, SCOControlInterference = 0.62 } },
                ...
                { "hpt_minelauncher_fixed_medium", new ShipModule(128049501,ShipModule.ModuleTypes.MineLauncher,"Mine Launcher Fixed Medium"){ Cost = 294080, Mount = "F", Class = 2, Rating = "I", Mass = 4, Integrity = 51, Power = 0.4, BootTime = 0, DPS = 44, Damage = 44, ThermL = 7.5, Pierce = 60, RateOfFire = 1, BurstInterval = 1, Clip = 3, Ammo = 72, ReloadTime = 6.6, BreachDamage = 13.2, BreachMin = 0, BreachMax = 0, ExplosiveProportionDamage = 59.091, ThermalProportionDamage = 40.909, AmmoCost = 209 } },
                ...
                { "hpt_mininglaser_fixed_small_advanced", new ShipModule(128671340,ShipModule.ModuleTypes.MiningLance,"Mining Lance Beam Laser Fixed Small"){ Cost = 33860, Mount = "F", Class = 1, Rating = "D", Mass = 2, Integrity = 40, Power = 0.7, BootTime = 0, DPS = 8, Damage = 8, DistributorDraw = 1.75, ThermL = 6, Pierce = 18, Range = 2000, BurstInterval = 0, BreachDamage = 1.2, BreachMin = 10, BreachMax = 20, ThermalProportionDamage = 100, Falloff = 500 } },
                ...
                { "hpt_drunkmissilerack_fixed_medium", new ShipModule(128671344,ShipModule.ModuleTypes.Pack_HoundMissileRack,"Pack Hound Missile Rack Fixed Medium"){ Cost = 768600, Mount = "F", MissileType = "S", Class = 2, Rating = "B", Mass = 4, Integrity = 51, Power = 1.2, BootTime = 0, DPS = 60, Damage = 7.5, DistributorDraw = 0.24, ThermL = 3.6, Pierce = 60, Speed = 600, RateOfFire = 2, BurstInterval = 0.5, Clip = 12, Ammo = 120, Rounds = 4, ReloadTime = 5, BreachDamage = 3, BreachMin = 0, BreachMax = 0, ExplosiveProportionDamage = 100, ThermalProportionDamage = 0, AmmoCost = 500 } },

                { "hpt_advancedtorppylon_fixed_small", new ShipModule(128049509,ShipModule.ModuleTypes.TorpedoPylon,"Advanced Torp Pylon Fixed Small"){ Cost = 11200, Mount = "F", MissileType = "S", Class = 1, Rating = "I", Mass = 2, Integrity = 40, Power = 0.4, BootTime = 0, DPS = 120, Damage = 120, ThermL = 45, Pierce = 10000, Speed = 250, RateOfFire = 1, BurstInterval = 1, Clip = 1, ReloadTime = 5, BreachDamage = 60, BreachMin = 100, BreachMax = 100, ExplosiveProportionDamage = 100, AmmoCost = 15000 } },
                ...
                { "hpt_advancedtorppylon_fixed_large", new ShipModule(128049511,ShipModule.ModuleTypes.TorpedoPylon,"Advanced Torp Pylon Fixed Large"){ Cost = 157960, Mount = "F", MissileType = "S", Class = 3, Rating = "I", Mass = 8, Integrity = 64, Power = 0.6, BootTime = 0, DPS = 120, Damage = 120, ThermL = 55, Pierce = 10000, Speed = 250, RateOfFire = 1, BurstInterval = 1, Clip = 4, ReloadTime = 5, BreachDamage = 60, BreachMin = 100, BreachMax = 100, ExplosiveProportionDamage = 100, AmmoCost = 15000 } },
                ...
                { "hpt_dumbfiremissilerack_fixed_medium_advanced", new ShipModule(128935983,ShipModule.ModuleTypes.AdvancedMissileRack,"Advanced Missile Rack Fixed Medium"){ Cost = 240400, Mount = "F", MissileType = "D", Class = 2, Rating = "B", Mass = 4, Integrity = 51, Power = 1.2, BootTime = 0, DPS = 25, Damage = 50, DistributorDraw = 0.24, ThermL = 3.6, Pierce = 60, Speed = 750, RateOfFire = 0.5, BurstInterval = 2, Clip = 12, Ammo = 64, ReloadTime = 5, BreachDamage = 20, BreachMin = 100, BreachMax = 100, ExplosiveProportionDamage = 100, ThermalProportionDamage = 0, AmmoCost = 500 } },

                { "hpt_human_extraction_fixed_medium", new ShipModule(129028577,ShipModule.ModuleTypes.MissileRack,"Human Extraction Missile Medium"){ Cost = 843170, Mount = "F", Class = 2, Rating = "B", Mass = 4, Integrity = 50, Power = 1, BootTime = 0, DPS = 2.5, Damage = 5, DistributorDraw = 0.21, ThermL = 2.9, Pierce = 25, Speed = 550, RateOfFire = 0.5, BurstInterval = 2, Clip = 1, Ammo = 96, ReloadTime = 2, BreachDamage = 0.5, BreachMin = 10, BreachMax = 20, ExplosiveProportionDamage = 100 } },
                ...
                { "hpt_atmulticannon_turret_medium", new ShipModule(128793059,ShipModule.ModuleTypes.AXMulti_Cannon,"AX Multi Cannon Turret Medium"){ Cost = 1826500, Mount = "T", Class = 2, Rating = "F", Mass = 4, Integrity = 51, Power = 0.5, BootTime = 0, DPS = 10.812, Damage = 1.73, DistributorDraw = 0.06, ThermL = 0.09, Pierce = 17, Range = 4000, Speed = 1600, RateOfFire = 6.25, BurstInterval = 0.16, Clip = 90, Ammo = 2100, ReloadTime = 4, BreachDamage = 0.4, BreachMin = 50, BreachMax = 50, AXPorportionDamage = 67.63, KineticProportionDamage = 32.37, Falloff = 2000, AmmoCost = 1 } },
                { "hpt_atmulticannon_turret_large", new ShipModule(128793060,ShipModule.ModuleTypes.AXMulti_Cannon,"AX Multi Cannon Turret Large"){ Cost = 3821600, Mount = "T", Class = 3, Rating = "E", Mass = 8, Integrity = 64, Power = 0.64, BootTime = 0, DPS = 20.688, Damage = 3.31, DistributorDraw = 0.06, ThermL = 0.09, Pierce = 33, Range = 4000, Speed = 1600, RateOfFire = 6.25, BurstInterval = 0.16, Clip = 90, Ammo = 2100, ReloadTime = 4, BreachDamage = 0.8, BreachMin = 50, BreachMax = 50, AXPorportionDamage = 66.163, KineticProportionDamage = 33.837, Falloff = 2000, AmmoCost = 1 } },
                ...
                { "hpt_atmulticannon_turret_medium_v2", new ShipModule(129022086,ShipModule.ModuleTypes.EnhancedAXMulti_Cannon,"Enhanced AX Multi Cannon Turret Medium"){ Cost = 2193300, Mount = "T", Class = 2, Rating = "E", Mass = 4, Integrity = 51, Power = 0.52, BootTime = 0, DPS = 12.5, Damage = 2, DistributorDraw = 0.06, ThermL = 0.1, Pierce = 17, Range = 4000, Speed = 4000, RateOfFire = 6.2, BurstInterval = 0.16, Clip = 90, Ammo = 2100, ReloadTime = 4, BreachDamage = 0.5, BreachMin = 50, BreachMax = 50, AXPorportionDamage = 70, KineticProportionDamage = 30, Falloff = 2000, AmmoCost = 1 } },
                { "hpt_atmulticannon_turret_large_v2", new ShipModule(129022085,ShipModule.ModuleTypes.EnhancedAXMulti_Cannon,"Enhanced AX Multi Cannon Turret Large"){ Cost = 4588710, Mount = "T", Class = 3, Rating = "D", Mass = 8, Integrity = 64, Power = 0.69, BootTime = 0, DPS = 24.4, Damage = 3.9, DistributorDraw = 0.06, ThermL = 0.1, Pierce = 33, Range = 4000, Speed = 4000, RateOfFire = 6.2, BurstInterval = 0.16, Clip = 90, Ammo = 2100, ReloadTime = 4, BreachDamage = 1, BreachMin = 50, BreachMax = 50, AXPorportionDamage = 71.795, KineticProportionDamage = 28.205, Falloff = 2000, AmmoCost = 1 } },
                ...
                { "hpt_multicannon_fixed_small", new ShipModule(128049455,ShipModule.ModuleTypes.Multi_Cannon,"Multi Cannon Fixed Small"){ Cost = 9500, Mount = "F", Class = 1, Rating = "F", Mass = 2, Integrity = 40, Power = 0.28, BootTime = 0, DPS = 8.615, Damage = 1.12, DistributorDraw = 0.06, ThermL = 0.09, Pierce = 22, Range = 4000, Speed = 1600, RateOfFire = 7.692, BurstInterval = 0.13, Clip = 100, Ammo = 2100, ReloadTime = 4, BreachDamage = 1, BreachMin = 40, BreachMax = 80, KineticProportionDamage = 100, ThermalProportionDamage = 0, Falloff = 2000, AmmoCost = 1 } },
                ...
                { "hpt_multicannon_gimbal_medium", new ShipModule(128049460,ShipModule.ModuleTypes.Multi_Cannon,"Multi Cannon Gimbal Medium"){ Cost = 57000, Mount = "G", Class = 2, Rating = "F", Mass = 4, Integrity = 51, Power = 0.64, BootTime = 0, DPS = 12.615, Damage = 1.64, DistributorDraw = 0.14, ThermL = 0.2, Pierce = 37, Range = 4000, Speed = 1600, RateOfFire = 7.692, BurstInterval = 0.13, Clip = 90, Ammo = 2100, ReloadTime = 5, BreachDamage = 1.5, BreachMin = 40, BreachMax = 80, KineticProportionDamage = 100, ThermalProportionDamage = 0, Falloff = 2000, AmmoCost = 1 } },
                ...
                { "hpt_multicannon_turret_medium", new ShipModule(128049463,ShipModule.ModuleTypes.Multi_Cannon,"Multi Cannon Turret Medium"){ Cost = 1292800, Mount = "T", Class = 2, Rating = "F", Mass = 4, Integrity = 51, Power = 0.5, BootTime = 0, DPS = 7.313, Damage = 1.17, DistributorDraw = 0.06, ThermL = 0.09, Pierce = 37, Range = 4000, Speed = 1600, RateOfFire = 6.25, BurstInterval = 0.16, Clip = 90, Ammo = 2100, ReloadTime = 4, BreachDamage = 1.1, BreachMin = 40, BreachMax = 80, KineticProportionDamage = 100, ThermalProportionDamage = 0, Falloff = 2000, AmmoCost = 1 } },
                ...
                { "hpt_plasmaaccelerator_fixed_medium", new ShipModule(128049465,ShipModule.ModuleTypes.PlasmaAccelerator,"Plasma Accelerator Fixed Medium"){ Cost = 834200, Mount = "F", Class = 2, Rating = "C", Mass = 4, Integrity = 51, Power = 1.43, BootTime = 0, DPS = 17.921, Damage = 54.3, DistributorDraw = 8.65, ThermL = 15.58, Pierce = 100, Range = 3500, Speed = 875, RateOfFire = 0.33, BurstInterval = 3.03, Clip = 5, Ammo = 100, ReloadTime = 6, BreachDamage = 46.2, BreachMin = 40, BreachMax = 80, AbsoluteProportionDamage = 59.853, KineticProportionDamage = 20.074, ThermalProportionDamage = 20.074, Falloff = 2000, AmmoCost = 200 } },
                ...
                { "hpt_plasmaaccelerator_fixed_huge", new ShipModule(128049467,ShipModule.ModuleTypes.PlasmaAccelerator,"Plasma Accelerator Fixed Huge"){ Cost = 13793600, Mount = "F", Class = 4, Rating = "A", Mass = 16, Integrity = 80, Power = 2.63, BootTime = 0, DPS = 31.313, Damage = 125.25, DistributorDraw = 21.04, ThermL = 29.46, Pierce = 100, Range = 3500, Speed = 875, RateOfFire = 0.25, BurstInterval = 4, Clip = 5, Ammo = 100, ReloadTime = 6, BreachDamage = 106.5, BreachMin = 40, BreachMax = 80, AbsoluteProportionDamage = 60.08, KineticProportionDamage = 19.96, ThermalProportionDamage = 19.96, Falloff = 2000, AmmoCost = 200 } },
                ...
                { "int_powerdistributor_size1_class1_free", new ShipModule(128666639,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 1 Rating E"){ Cost = 520, Class = 1, Rating = "E", Mass = 1.3, Integrity = 36, Power = 0.32, BootTime = 5, WeaponsCapacity = 10, WeaponsRechargeRate = 1.2, EngineCapacity = 8, EngineRechargeRate = 0.4, SystemsCapacity = 8, SystemsRechargeRate = 0.4 } },
                { "int_powerdistributor_size1_class1", new ShipModule(128064178,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 1 Rating E"){ Cost = 520, Class = 1, Rating = "E", Mass = 1.3, Integrity = 36, Power = 0.32, BootTime = 5, WeaponsCapacity = 10, WeaponsRechargeRate = 1.2, EngineCapacity = 8, EngineRechargeRate = 0.4, SystemsCapacity = 8, SystemsRechargeRate = 0.4 } },
                { "int_powerdistributor_size1_class2", new ShipModule(128064179,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 1 Rating D"){ Cost = 1290, Class = 1, Rating = "D", Mass = 0.5, Integrity = 32, Power = 0.36, BootTime = 5, WeaponsCapacity = 11, WeaponsRechargeRate = 1.4, EngineCapacity = 9, EngineRechargeRate = 0.5, SystemsCapacity = 9, SystemsRechargeRate = 0.5 } },
                { "int_powerdistributor_size1_class3", new ShipModule(128064180,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 1 Rating C"){ Cost = 3230, Class = 1, Rating = "C", Mass = 1.3, Integrity = 40, Power = 0.4, BootTime = 5, WeaponsCapacity = 12, WeaponsRechargeRate = 1.5, EngineCapacity = 10, EngineRechargeRate = 0.5, SystemsCapacity = 10, SystemsRechargeRate = 0.5 } },
                { "int_powerdistributor_size1_class4", new ShipModule(128064181,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 1 Rating B"){ Cost = 8080, Class = 1, Rating = "B", Mass = 2, Integrity = 48, Power = 0.44, BootTime = 5, WeaponsCapacity = 13, WeaponsRechargeRate = 1.7, EngineCapacity = 11, EngineRechargeRate = 0.6, SystemsCapacity = 11, SystemsRechargeRate = 0.6 } },
                { "int_powerdistributor_size1_class5", new ShipModule(128064182,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 1 Rating A"){ Cost = 20200, Class = 1, Rating = "A", Mass = 1.3, Integrity = 44, Power = 0.48, BootTime = 5, WeaponsCapacity = 14, WeaponsRechargeRate = 1.8, EngineCapacity = 12, EngineRechargeRate = 0.6, SystemsCapacity = 12, SystemsRechargeRate = 0.6 } },
                { "int_powerdistributor_size2_class1", new ShipModule(128064183,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 2 Rating E"){ Cost = 1450, Class = 2, Rating = "E", Mass = 2.5, Integrity = 46, Power = 0.36, BootTime = 5, WeaponsCapacity = 12, WeaponsRechargeRate = 1.4, EngineCapacity = 10, EngineRechargeRate = 0.6, SystemsCapacity = 10, SystemsRechargeRate = 0.6 } },
                { "int_powerdistributor_size2_class2", new ShipModule(128064184,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 2 Rating D"){ Cost = 3620, Class = 2, Rating = "D", Mass = 1, Integrity = 41, Power = 0.41, BootTime = 5, WeaponsCapacity = 14, WeaponsRechargeRate = 1.6, EngineCapacity = 11, EngineRechargeRate = 0.6, SystemsCapacity = 11, SystemsRechargeRate = 0.6 } },
                { "int_powerdistributor_size2_class3", new ShipModule(128064185,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 2 Rating C"){ Cost = 9050, Class = 2, Rating = "C", Mass = 2.5, Integrity = 51, Power = 0.45, BootTime = 5, WeaponsCapacity = 15, WeaponsRechargeRate = 1.8, EngineCapacity = 12, EngineRechargeRate = 0.7, SystemsCapacity = 12, SystemsRechargeRate = 0.7 } },
                { "int_powerdistributor_size2_class4", new ShipModule(128064186,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 2 Rating B"){ Cost = 22620, Class = 2, Rating = "B", Mass = 4, Integrity = 61, Power = 0.5, BootTime = 5, WeaponsCapacity = 17, WeaponsRechargeRate = 2, EngineCapacity = 13, EngineRechargeRate = 0.8, SystemsCapacity = 13, SystemsRechargeRate = 0.8 } },
                { "int_powerdistributor_size2_class5", new ShipModule(128064187,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 2 Rating A"){ Cost = 56550, Class = 2, Rating = "A", Mass = 2.5, Integrity = 56, Power = 0.54, BootTime = 5, WeaponsCapacity = 18, WeaponsRechargeRate = 2.2, EngineCapacity = 14, EngineRechargeRate = 0.8, SystemsCapacity = 14, SystemsRechargeRate = 0.8 } },
                { "int_powerdistributor_size3_class1", new ShipModule(128064188,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 3 Rating E"){ Cost = 4050, Class = 3, Rating = "E", Mass = 5, Integrity = 58, Power = 0.4, BootTime = 5, WeaponsCapacity = 16, WeaponsRechargeRate = 1.8, EngineCapacity = 12, EngineRechargeRate = 0.9, SystemsCapacity = 12, SystemsRechargeRate = 0.9 } },
                { "int_powerdistributor_size3_class2", new ShipModule(128064189,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 3 Rating D"){ Cost = 10130, Class = 3, Rating = "D", Mass = 2, Integrity = 51, Power = 0.45, BootTime = 5, WeaponsCapacity = 18, WeaponsRechargeRate = 2.1, EngineCapacity = 14, EngineRechargeRate = 1, SystemsCapacity = 14, SystemsRechargeRate = 1 } },
                { "int_powerdistributor_size3_class3", new ShipModule(128064190,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 3 Rating C"){ Cost = 25330, Class = 3, Rating = "C", Mass = 5, Integrity = 64, Power = 0.5, BootTime = 5, WeaponsCapacity = 20, WeaponsRechargeRate = 2.3, EngineCapacity = 15, EngineRechargeRate = 1.1, SystemsCapacity = 15, SystemsRechargeRate = 1.1 } },
                { "int_powerdistributor_size3_class4", new ShipModule(128064191,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 3 Rating B"){ Cost = 63330, Class = 3, Rating = "B", Mass = 8, Integrity = 77, Power = 0.55, BootTime = 5, WeaponsCapacity = 22, WeaponsRechargeRate = 2.5, EngineCapacity = 17, EngineRechargeRate = 1.2, SystemsCapacity = 17, SystemsRechargeRate = 1.2 } },
                { "int_powerdistributor_size3_class5", new ShipModule(128064192,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 3 Rating A"){ Cost = 158330, Class = 3, Rating = "A", Mass = 5, Integrity = 70, Power = 0.6, BootTime = 5, WeaponsCapacity = 24, WeaponsRechargeRate = 2.8, EngineCapacity = 18, EngineRechargeRate = 1.3, SystemsCapacity = 18, SystemsRechargeRate = 1.3 } },
                { "int_powerdistributor_size4_class1", new ShipModule(128064193,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 4 Rating E"){ Cost = 11350, Class = 4, Rating = "E", Mass = 10, Integrity = 72, Power = 0.45, BootTime = 5, WeaponsCapacity = 22, WeaponsRechargeRate = 2.3, EngineCapacity = 15, EngineRechargeRate = 1.3, SystemsCapacity = 15, SystemsRechargeRate = 1.3 } },
                { "int_powerdistributor_size4_class2", new ShipModule(128064194,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 4 Rating D"){ Cost = 28370, Class = 4, Rating = "D", Mass = 4, Integrity = 64, Power = 0.5, BootTime = 5, WeaponsCapacity = 24, WeaponsRechargeRate = 2.6, EngineCapacity = 17, EngineRechargeRate = 1.4, SystemsCapacity = 17, SystemsRechargeRate = 1.4 } },
                { "int_powerdistributor_size4_class3", new ShipModule(128064195,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 4 Rating C"){ Cost = 70930, Class = 4, Rating = "C", Mass = 10, Integrity = 80, Power = 0.56, BootTime = 5, WeaponsCapacity = 27, WeaponsRechargeRate = 2.9, EngineCapacity = 19, EngineRechargeRate = 1.6, SystemsCapacity = 19, SystemsRechargeRate = 1.6 } },
                { "int_powerdistributor_size4_class4", new ShipModule(128064196,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 4 Rating B"){ Cost = 177330, Class = 4, Rating = "B", Mass = 16, Integrity = 96, Power = 0.62, BootTime = 5, WeaponsCapacity = 30, WeaponsRechargeRate = 3.2, EngineCapacity = 21, EngineRechargeRate = 1.8, SystemsCapacity = 21, SystemsRechargeRate = 1.8 } },
                { "int_powerdistributor_size4_class5", new ShipModule(128064197,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 4 Rating A"){ Cost = 443330, Class = 4, Rating = "A", Mass = 10, Integrity = 88, Power = 0.67, BootTime = 5, WeaponsCapacity = 32, WeaponsRechargeRate = 3.5, EngineCapacity = 23, EngineRechargeRate = 1.9, SystemsCapacity = 23, SystemsRechargeRate = 1.9 } },
                { "int_powerdistributor_size5_class1", new ShipModule(128064198,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 5 Rating E"){ Cost = 31780, Class = 5, Rating = "E", Mass = 20, Integrity = 86, Power = 0.5, BootTime = 5, WeaponsCapacity = 27, WeaponsRechargeRate = 2.9, EngineCapacity = 19, EngineRechargeRate = 1.7, SystemsCapacity = 19, SystemsRechargeRate = 1.7 } },
                { "int_powerdistributor_size5_class2", new ShipModule(128064199,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 5 Rating D"){ Cost = 79440, Class = 5, Rating = "D", Mass = 8, Integrity = 77, Power = 0.56, BootTime = 5, WeaponsCapacity = 31, WeaponsRechargeRate = 3.2, EngineCapacity = 22, EngineRechargeRate = 1.9, SystemsCapacity = 22, SystemsRechargeRate = 1.9 } },
                { "int_powerdistributor_size5_class3", new ShipModule(128064200,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 5 Rating C"){ Cost = 198610, Class = 5, Rating = "C", Mass = 20, Integrity = 96, Power = 0.62, BootTime = 5, WeaponsCapacity = 34, WeaponsRechargeRate = 3.6, EngineCapacity = 24, EngineRechargeRate = 2.1, SystemsCapacity = 24, SystemsRechargeRate = 2.1 } },
                { "int_powerdistributor_size5_class4", new ShipModule(128064201,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 5 Rating B"){ Cost = 496530, Class = 5, Rating = "B", Mass = 32, Integrity = 115, Power = 0.68, BootTime = 5, WeaponsCapacity = 37, WeaponsRechargeRate = 4, EngineCapacity = 26, EngineRechargeRate = 2.3, SystemsCapacity = 26, SystemsRechargeRate = 2.3 } },
                { "int_powerdistributor_size5_class5", new ShipModule(128064202,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 5 Rating A"){ Cost = 1241320, Class = 5, Rating = "A", Mass = 20, Integrity = 106, Power = 0.74, BootTime = 5, WeaponsCapacity = 41, WeaponsRechargeRate = 4.3, EngineCapacity = 29, EngineRechargeRate = 2.5, SystemsCapacity = 29, SystemsRechargeRate = 2.5 } },
                { "int_powerdistributor_size6_class1", new ShipModule(128064203,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 6 Rating E"){ Cost = 88980, Class = 6, Rating = "E", Mass = 40, Integrity = 102, Power = 0.54, BootTime = 5, WeaponsCapacity = 34, WeaponsRechargeRate = 3.4, EngineCapacity = 23, EngineRechargeRate = 2.2, SystemsCapacity = 23, SystemsRechargeRate = 2.2 } },
                { "int_powerdistributor_size6_class2", new ShipModule(128064204,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 6 Rating D"){ Cost = 222440, Class = 6, Rating = "D", Mass = 16, Integrity = 90, Power = 0.61, BootTime = 5, WeaponsCapacity = 38, WeaponsRechargeRate = 3.9, EngineCapacity = 26, EngineRechargeRate = 2.4, SystemsCapacity = 26, SystemsRechargeRate = 2.4 } },
                { "int_powerdistributor_size6_class3", new ShipModule(128064205,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 6 Rating C"){ Cost = 556110, Class = 6, Rating = "C", Mass = 40, Integrity = 113, Power = 0.68, BootTime = 5, WeaponsCapacity = 42, WeaponsRechargeRate = 4.3, EngineCapacity = 29, EngineRechargeRate = 2.7, SystemsCapacity = 29, SystemsRechargeRate = 2.7 } },
                ...
                { "int_powerdistributor_size6_class5", new ShipModule(128064207,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 6 Rating A"){ Cost = 3475690, Class = 6, Rating = "A", Mass = 40, Integrity = 124, Power = 0.82, BootTime = 5, WeaponsCapacity = 50, WeaponsRechargeRate = 5.2, EngineCapacity = 35, EngineRechargeRate = 3.2, SystemsCapacity = 35, SystemsRechargeRate = 3.2 } },
                { "int_powerdistributor_size7_class1", new ShipModule(128064208,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 7 Rating E"){ Cost = 249140, Class = 7, Rating = "E", Mass = 80, Integrity = 118, Power = 0.59, BootTime = 5, WeaponsCapacity = 41, WeaponsRechargeRate = 4.1, EngineCapacity = 27, EngineRechargeRate = 2.6, SystemsCapacity = 27, SystemsRechargeRate = 2.6 } },
                { "int_powerdistributor_size7_class2", new ShipModule(128064209,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 7 Rating D"){ Cost = 622840, Class = 7, Rating = "D", Mass = 32, Integrity = 105, Power = 0.67, BootTime = 5, WeaponsCapacity = 46, WeaponsRechargeRate = 4.6, EngineCapacity = 31, EngineRechargeRate = 3, SystemsCapacity = 31, SystemsRechargeRate = 3 } },
                { "int_powerdistributor_size7_class3", new ShipModule(128064210,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 7 Rating C"){ Cost = 1557110, Class = 7, Rating = "C", Mass = 80, Integrity = 131, Power = 0.74, BootTime = 5, WeaponsCapacity = 51, WeaponsRechargeRate = 5.1, EngineCapacity = 34, EngineRechargeRate = 3.3, SystemsCapacity = 34, SystemsRechargeRate = 3.3 } },
                { "int_powerdistributor_size7_class4", new ShipModule(128064211,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 7 Rating B"){ Cost = 3892770, Class = 7, Rating = "B", Mass = 128, Integrity = 157, Power = 0.81, BootTime = 5, WeaponsCapacity = 56, WeaponsRechargeRate = 5.6, EngineCapacity = 37, EngineRechargeRate = 3.6, SystemsCapacity = 37, SystemsRechargeRate = 3.6 } },
                { "int_powerdistributor_size7_class5", new ShipModule(128064212,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 7 Rating A"){ Cost = 9731930, Class = 7, Rating = "A", Mass = 80, Integrity = 144, Power = 0.89, BootTime = 5, WeaponsCapacity = 61, WeaponsRechargeRate = 6.1, EngineCapacity = 41, EngineRechargeRate = 4, SystemsCapacity = 41, SystemsRechargeRate = 4 } },
                { "int_powerdistributor_size8_class1", new ShipModule(128064213,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 8 Rating E"){ Cost = 697580, Class = 8, Rating = "E", Mass = 160, Integrity = 135, Power = 0.64, BootTime = 5, WeaponsCapacity = 48, WeaponsRechargeRate = 4.8, EngineCapacity = 32, EngineRechargeRate = 3.2, SystemsCapacity = 32, SystemsRechargeRate = 3.2 } },
                { "int_powerdistributor_size8_class2", new ShipModule(128064214,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 8 Rating D"){ Cost = 1743960, Class = 8, Rating = "D", Mass = 64, Integrity = 120, Power = 0.72, BootTime = 5, WeaponsCapacity = 54, WeaponsRechargeRate = 5.4, EngineCapacity = 36, EngineRechargeRate = 3.6, SystemsCapacity = 36, SystemsRechargeRate = 3.6 } },
                { "int_powerdistributor_size8_class3", new ShipModule(128064215,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 8 Rating C"){ Cost = 4359900, Class = 8, Rating = "C", Mass = 160, Integrity = 150, Power = 0.8, BootTime = 5, WeaponsCapacity = 60, WeaponsRechargeRate = 6, EngineCapacity = 40, EngineRechargeRate = 4, SystemsCapacity = 40, SystemsRechargeRate = 4 } },
                { "int_powerdistributor_size8_class4", new ShipModule(128064216,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 8 Rating B"){ Cost = 10899760, Class = 8, Rating = "B", Mass = 256, Integrity = 180, Power = 0.88, BootTime = 5, WeaponsCapacity = 66, WeaponsRechargeRate = 6.6, EngineCapacity = 44, EngineRechargeRate = 4.4, SystemsCapacity = 44, SystemsRechargeRate = 4.4 } },
                { "int_powerdistributor_size8_class5", new ShipModule(128064217,ShipModule.ModuleTypes.PowerDistributor,"Power Distributor Class 8 Rating A"){ Cost = 27249390, Class = 8, Rating = "A", Mass = 160, Integrity = 165, Power = 0.96, BootTime = 5, WeaponsCapacity = 72, WeaponsRechargeRate = 7.2, EngineCapacity = 48, EngineRechargeRate = 4.8, SystemsCapacity = 48, SystemsRechargeRate = 4.8 } },
                ...
                { "hpt_pulselaser_fixed_smallfree", new ShipModule(128049673,ShipModule.ModuleTypes.PulseLaser,"Pulse Laser Fixed Small Free"){ Cost = 2200, Mount = "F", Class = 1, Rating = "F", Mass = 2, Integrity = 40, Power = 0.39, BootTime = 0, DPS = 7.885, Damage = 2.05, DistributorDraw = 0.3, ThermL = 0.33, Pierce = 20, Range = 3000, RateOfFire = 3.846, BurstInterval = 0.26, BreachDamage = 1.7, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 500 } },
                ...
                { "hpt_pulselaser_fixed_large", new ShipModule(128049383,ShipModule.ModuleTypes.PulseLaser,"Pulse Laser Fixed Large"){ Cost = 70400, Mount = "F", Class = 3, Rating = "D", Mass = 8, Integrity = 64, Power = 0.9, BootTime = 0, DPS = 18.121, Damage = 5.98, DistributorDraw = 0.86, ThermL = 0.96, Pierce = 52, Range = 3000, RateOfFire = 3.03, BurstInterval = 0.33, BreachDamage = 5.1, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 500 } },
                { "hpt_pulselaser_fixed_huge", new ShipModule(128049384,ShipModule.ModuleTypes.PulseLaser,"Pulse Laser Fixed Huge"){ Cost = 177600, Mount = "F", Class = 4, Rating = "A", Mass = 16, Integrity = 80, Power = 1.33, BootTime = 0, DPS = 26.947, Damage = 10.24, DistributorDraw = 1.48, ThermL = 1.64, Pierce = 65, Range = 3000, RateOfFire = 2.632, BurstInterval = 0.38, BreachDamage = 8.7, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 500 } },
                { "hpt_pulselaser_gimbal_small", new ShipModule(128049385,ShipModule.ModuleTypes.PulseLaser,"Pulse Laser Gimbal Small"){ Cost = 6600, Mount = "G", Class = 1, Rating = "G", Mass = 2, Integrity = 40, Power = 0.39, BootTime = 0, DPS = 6.24, Damage = 1.56, DistributorDraw = 0.31, ThermL = 0.31, Pierce = 20, Range = 3000, RateOfFire = 4, BurstInterval = 0.25, BreachDamage = 1.3, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 500 } },
                ...
                { "hpt_pulselaser_turret_small", new ShipModule(128049388,ShipModule.ModuleTypes.PulseLaser,"Pulse Laser Turret Small"){ Cost = 26000, Mount = "T", Class = 1, Rating = "G", Mass = 2, Integrity = 40, Power = 0.38, BootTime = 0, DPS = 3.967, Damage = 1.19, DistributorDraw = 0.19, ThermL = 0.19, Pierce = 20, Range = 3000, RateOfFire = 3.333, BurstInterval = 0.3, BreachDamage = 1, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 500 } },
                { "hpt_pulselaser_turret_medium", new ShipModule(128049389,ShipModule.ModuleTypes.PulseLaser,"Pulse Laser Turret Medium"){ Cost = 132800, Mount = "T", Class = 2, Rating = "F", Mass = 4, Integrity = 51, Power = 0.58, BootTime = 0, DPS = 6.212, Damage = 2.05, DistributorDraw = 0.33, ThermL = 0.33, Pierce = 35, Range = 3000, RateOfFire = 3.03, BurstInterval = 0.33, BreachDamage = 1.7, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 500 } },
                { "hpt_pulselaser_turret_large", new ShipModule(128049390,ShipModule.ModuleTypes.PulseLaser,"Pulse Laser Turret Large"){ Cost = 400400, Mount = "T", Class = 3, Rating = "F", Mass = 8, Integrity = 64, Power = 0.89, BootTime = 0, DPS = 9.459, Damage = 3.5, DistributorDraw = 0.56, ThermL = 0.56, Pierce = 52, Range = 3000, RateOfFire = 2.703, BurstInterval = 0.37, BreachDamage = 3, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 500 } },


                { "hpt_pulselaser_gimbal_huge", new ShipModule(128681995,ShipModule.ModuleTypes.PulseLaser,"Pulse Laser Gimbal Huge"){ Cost = 877600, Mount = "G", Class = 4, Rating = "A", Mass = 16, Integrity = 80, Power = 1.37, BootTime = 0, DPS = 21.722, Damage = 7.82, DistributorDraw = 1.56, ThermL = 1.56, Pierce = 65, Range = 3000, RateOfFire = 2.778, BurstInterval = 0.36, BreachDamage = 6.6, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 100, Falloff = 500 } },
                ...
                { "hpt_railgun_fixed_medium", new ShipModule(128049489,ShipModule.ModuleTypes.RailGun,"Rail Gun Fixed Medium"){ Cost = 412800, Mount = "F", Class = 2, Rating = "B", Mass = 4, Integrity = 51, Power = 1.63, BootTime = 0, DPS = 50.036, Damage = 41.53, DistributorDraw = 5.11, ThermL = 20, Pierce = 100, Range = 3000, Time = 1.2, RateOfFire = 1.205, BurstInterval = 0.83, Clip = 1, Ammo = 80, ReloadTime = 1, BreachDamage = 39.5, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 66.675, KineticProportionDamage = 33.325, Falloff = 1000, AmmoCost = 75 } },
                { "hpt_railgun_fixed_medium_burst", new ShipModule(128671341,ShipModule.ModuleTypes.ImperialHammerRailGun,"Imperial Hammer Rail Gun Fixed Medium"){ Cost = 619200, Mount = "F", Class = 2, Rating = "B", Mass = 4, Integrity = 51, Power = 1.63, BootTime = 0, DPS = 61.364, Damage = 15, DistributorDraw = 2, ThermL = 11, Pierce = 100, Range = 3000, Time = 1.2, RateOfFire = 4.091, BurstInterval = 0.4, BurstRateOfFire = 6, BurstSize = 3, Clip = 3, Ammo = 240, ReloadTime = 1.2, BreachDamage = 14.3, BreachMin = 40, BreachMax = 80, ThermalProportionDamage = 66.667, KineticProportionDamage = 33.333, Falloff = 1000, AmmoCost = 75 } },
                ...
                { "int_sensors_size1_class1_free", new ShipModule(128666640,ShipModule.ModuleTypes.Sensors,"Sensors Class 1 Rating E"){ Cost = 520, Class = 1, Rating = "E", Mass = 1.3, Integrity = 36, Power = 0.16, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4000 } },
                { "int_sensors_size1_class1", new ShipModule(128064218,ShipModule.ModuleTypes.Sensors,"Sensors Class 1 Rating E"){ Cost = 520, Class = 1, Rating = "E", Mass = 1.3, Integrity = 36, Power = 0.16, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4000 } },
                { "int_sensors_size1_class2", new ShipModule(128064219,ShipModule.ModuleTypes.Sensors,"Sensors Class 1 Rating D"){ Cost = 1290, Class = 1, Rating = "D", Mass = 0.5, Integrity = 32, Power = 0.18, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4500 } },
                { "int_sensors_size1_class3", new ShipModule(128064220,ShipModule.ModuleTypes.Sensors,"Sensors Class 1 Rating C"){ Cost = 3230, Class = 1, Rating = "C", Mass = 1.3, Integrity = 40, Power = 0.2, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5000 } },
                { "int_sensors_size1_class4", new ShipModule(128064221,ShipModule.ModuleTypes.Sensors,"Sensors Class 1 Rating B"){ Cost = 8080, Class = 1, Rating = "B", Mass = 2, Integrity = 48, Power = 0.33, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5500 } },
                { "int_sensors_size1_class5", new ShipModule(128064222,ShipModule.ModuleTypes.Sensors,"Sensors Class 1 Rating A"){ Cost = 20200, Class = 1, Rating = "A", Mass = 1.3, Integrity = 44, Power = 0.6, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6000 } },
                { "int_sensors_size2_class1", new ShipModule(128064223,ShipModule.ModuleTypes.Sensors,"Sensors Class 2 Rating E"){ Cost = 1450, Class = 2, Rating = "E", Mass = 2.5, Integrity = 46, Power = 0.18, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4160 } },
                { "int_sensors_size2_class2", new ShipModule(128064224,ShipModule.ModuleTypes.Sensors,"Sensors Class 2 Rating D"){ Cost = 3620, Class = 2, Rating = "D", Mass = 1, Integrity = 41, Power = 0.21, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4680 } },
                { "int_sensors_size2_class3", new ShipModule(128064225,ShipModule.ModuleTypes.Sensors,"Sensors Class 2 Rating C"){ Cost = 9050, Class = 2, Rating = "C", Mass = 2.5, Integrity = 51, Power = 0.23, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5200 } },
                { "int_sensors_size2_class4", new ShipModule(128064226,ShipModule.ModuleTypes.Sensors,"Sensors Class 2 Rating B"){ Cost = 22620, Class = 2, Rating = "B", Mass = 4, Integrity = 61, Power = 0.38, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5720 } },
                { "int_sensors_size2_class5", new ShipModule(128064227,ShipModule.ModuleTypes.Sensors,"Sensors Class 2 Rating A"){ Cost = 56550, Class = 2, Rating = "A", Mass = 2.5, Integrity = 56, Power = 0.69, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6240 } },
                { "int_sensors_size3_class1", new ShipModule(128064228,ShipModule.ModuleTypes.Sensors,"Sensors Class 3 Rating E"){ Cost = 4050, Class = 3, Rating = "E", Mass = 5, Integrity = 58, Power = 0.22, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4320 } },
                { "int_sensors_size3_class2", new ShipModule(128064229,ShipModule.ModuleTypes.Sensors,"Sensors Class 3 Rating D"){ Cost = 10130, Class = 3, Rating = "D", Mass = 2, Integrity = 51, Power = 0.25, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4860 } },
                { "int_sensors_size3_class3", new ShipModule(128064230,ShipModule.ModuleTypes.Sensors,"Sensors Class 3 Rating C"){ Cost = 25330, Class = 3, Rating = "C", Mass = 5, Integrity = 64, Power = 0.28, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5400 } },
                { "int_sensors_size3_class4", new ShipModule(128064231,ShipModule.ModuleTypes.Sensors,"Sensors Class 3 Rating B"){ Cost = 63330, Class = 3, Rating = "B", Mass = 8, Integrity = 77, Power = 0.46, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5940 } },
                { "int_sensors_size3_class5", new ShipModule(128064232,ShipModule.ModuleTypes.Sensors,"Sensors Class 3 Rating A"){ Cost = 158330, Class = 3, Rating = "A", Mass = 5, Integrity = 70, Power = 0.84, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6480 } },
                { "int_sensors_size4_class1", new ShipModule(128064233,ShipModule.ModuleTypes.Sensors,"Sensors Class 4 Rating E"){ Cost = 11350, Class = 4, Rating = "E", Mass = 10, Integrity = 72, Power = 0.27, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4480 } },
                { "int_sensors_size4_class2", new ShipModule(128064234,ShipModule.ModuleTypes.Sensors,"Sensors Class 4 Rating D"){ Cost = 28370, Class = 4, Rating = "D", Mass = 4, Integrity = 64, Power = 0.31, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5040 } },
                { "int_sensors_size4_class3", new ShipModule(128064235,ShipModule.ModuleTypes.Sensors,"Sensors Class 4 Rating C"){ Cost = 70930, Class = 4, Rating = "C", Mass = 10, Integrity = 80, Power = 0.34, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5600 } },
                { "int_sensors_size4_class4", new ShipModule(128064236,ShipModule.ModuleTypes.Sensors,"Sensors Class 4 Rating B"){ Cost = 177330, Class = 4, Rating = "B", Mass = 16, Integrity = 96, Power = 0.56, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6160 } },
                { "int_sensors_size4_class5", new ShipModule(128064237,ShipModule.ModuleTypes.Sensors,"Sensors Class 4 Rating A"){ Cost = 443330, Class = 4, Rating = "A", Mass = 10, Integrity = 88, Power = 1.02, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6720 } },
                { "int_sensors_size5_class1", new ShipModule(128064238,ShipModule.ModuleTypes.Sensors,"Sensors Class 5 Rating E"){ Cost = 31780, Class = 5, Rating = "E", Mass = 20, Integrity = 86, Power = 0.33, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4640 } },
                { "int_sensors_size5_class2", new ShipModule(128064239,ShipModule.ModuleTypes.Sensors,"Sensors Class 5 Rating D"){ Cost = 79440, Class = 5, Rating = "D", Mass = 8, Integrity = 77, Power = 0.37, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5220 } },
                { "int_sensors_size5_class3", new ShipModule(128064240,ShipModule.ModuleTypes.Sensors,"Sensors Class 5 Rating C"){ Cost = 198610, Class = 5, Rating = "C", Mass = 20, Integrity = 96, Power = 0.41, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5800 } },
                { "int_sensors_size5_class4", new ShipModule(128064241,ShipModule.ModuleTypes.Sensors,"Sensors Class 5 Rating B"){ Cost = 496530, Class = 5, Rating = "B", Mass = 32, Integrity = 115, Power = 0.68, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6380 } },
                { "int_sensors_size5_class5", new ShipModule(128064242,ShipModule.ModuleTypes.Sensors,"Sensors Class 5 Rating A"){ Cost = 1241320, Class = 5, Rating = "A", Mass = 20, Integrity = 106, Power = 1.23, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6960 } },
                { "int_sensors_size6_class1", new ShipModule(128064243,ShipModule.ModuleTypes.Sensors,"Sensors Class 6 Rating E"){ Cost = 88980, Class = 6, Rating = "E", Mass = 40, Integrity = 102, Power = 0.4, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4800 } },
                { "int_sensors_size6_class2", new ShipModule(128064244,ShipModule.ModuleTypes.Sensors,"Sensors Class 6 Rating D"){ Cost = 222440, Class = 6, Rating = "D", Mass = 16, Integrity = 90, Power = 0.45, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5400 } },
                { "int_sensors_size6_class3", new ShipModule(128064245,ShipModule.ModuleTypes.Sensors,"Sensors Class 6 Rating C"){ Cost = 556110, Class = 6, Rating = "C", Mass = 40, Integrity = 113, Power = 0.5, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6000 } },
                { "int_sensors_size6_class4", new ShipModule(128064246,ShipModule.ModuleTypes.Sensors,"Sensors Class 6 Rating B"){ Cost = 1390280, Class = 6, Rating = "B", Mass = 64, Integrity = 136, Power = 0.83, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6600 } },
                { "int_sensors_size6_class5", new ShipModule(128064247,ShipModule.ModuleTypes.Sensors,"Sensors Class 6 Rating A"){ Cost = 3475690, Class = 6, Rating = "A", Mass = 40, Integrity = 124, Power = 1.5, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 7200 } },
                { "int_sensors_size7_class1", new ShipModule(128064248,ShipModule.ModuleTypes.Sensors,"Sensors Class 7 Rating E"){ Cost = 249140, Class = 7, Rating = "E", Mass = 80, Integrity = 118, Power = 0.47, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 4960 } },
                { "int_sensors_size7_class2", new ShipModule(128064249,ShipModule.ModuleTypes.Sensors,"Sensors Class 7 Rating D"){ Cost = 622840, Class = 7, Rating = "D", Mass = 32, Integrity = 105, Power = 0.53, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5580 } },
                { "int_sensors_size7_class3", new ShipModule(128064250,ShipModule.ModuleTypes.Sensors,"Sensors Class 7 Rating C"){ Cost = 1557110, Class = 7, Rating = "C", Mass = 80, Integrity = 131, Power = 0.59, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6200 } },
                { "int_sensors_size7_class4", new ShipModule(128064251,ShipModule.ModuleTypes.Sensors,"Sensors Class 7 Rating B"){ Cost = 3892770, Class = 7, Rating = "B", Mass = 128, Integrity = 157, Power = 0.97, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6820 } },
                { "int_sensors_size7_class5", new ShipModule(128064252,ShipModule.ModuleTypes.Sensors,"Sensors Class 7 Rating A"){ Cost = 9731930, Class = 7, Rating = "A", Mass = 80, Integrity = 144, Power = 1.77, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 7440 } },
                { "int_sensors_size8_class1", new ShipModule(128064253,ShipModule.ModuleTypes.Sensors,"Sensors Class 8 Rating E"){ Cost = 697580, Class = 8, Rating = "E", Mass = 160, Integrity = 135, Power = 0.55, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5120 } },
                { "int_sensors_size8_class2", new ShipModule(128064254,ShipModule.ModuleTypes.Sensors,"Sensors Class 8 Rating D"){ Cost = 1743960, Class = 8, Rating = "D", Mass = 64, Integrity = 120, Power = 0.62, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 5760 } },
                { "int_sensors_size8_class3", new ShipModule(128064255,ShipModule.ModuleTypes.Sensors,"Sensors Class 8 Rating C"){ Cost = 4359900, Class = 8, Rating = "C", Mass = 160, Integrity = 150, Power = 0.69, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 6400 } },
                { "int_sensors_size8_class4", new ShipModule(128064256,ShipModule.ModuleTypes.Sensors,"Sensors Class 8 Rating B"){ Cost = 10899760, Class = 8, Rating = "B", Mass = 256, Integrity = 180, Power = 1.14, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 7040 } },
                { "int_sensors_size8_class5", new ShipModule(128064257,ShipModule.ModuleTypes.Sensors,"Sensors Class 8 Rating A"){ Cost = 27249390, Class = 8, Rating = "A", Mass = 160, Integrity = 165, Power = 2.07, BootTime = 5, Range = 8000, Angle = 30, TypicalEmission = 7680 } },


                // Shield Boosters

                { "hpt_shieldbooster_size0_class1", new ShipModule(128668532,ShipModule.ModuleTypes.ShieldBooster,"Shield Booster Rating E"){ Cost = 10000, Class = 0, Rating = "E", Mass = 0.5, Integrity = 25, Power = 0.2, BootTime = 0, ShieldReinforcement = 4, KineticResistance = 0, ThermalResistance = 0, ExplosiveResistance = 0 } },
                { "hpt_shieldbooster_size0_class2", new ShipModule(128668533,ShipModule.ModuleTypes.ShieldBooster,"Shield Booster Rating D"){ Cost = 23000, Class = 0, Rating = "D", Mass = 1, Integrity = 35, Power = 0.5, BootTime = 0, ShieldReinforcement = 8, KineticResistance = 0, ThermalResistance = 0, ExplosiveResistance = 0 } },
                { "hpt_shieldbooster_size0_class3", new ShipModule(128668534,ShipModule.ModuleTypes.ShieldBooster,"Shield Booster Rating C"){ Cost = 53000, Class = 0, Rating = "C", Mass = 2, Integrity = 40, Power = 0.7, BootTime = 0, ShieldReinforcement = 12, KineticResistance = 0, ThermalResistance = 0, ExplosiveResistance = 0 } },
                { "hpt_shieldbooster_size0_class4", new ShipModule(128668535,ShipModule.ModuleTypes.ShieldBooster,"Shield Booster Rating B"){ Cost = 122000, Class = 0, Rating = "B", Mass = 3, Integrity = 45, Power = 1, BootTime = 0, ShieldReinforcement = 16, KineticResistance = 0, ThermalResistance = 0, ExplosiveResistance = 0 } },
                { "hpt_shieldbooster_size0_class5", new ShipModule(128668536,ShipModule.ModuleTypes.ShieldBooster,"Shield Booster Rating A"){ Cost = 281000, Class = 0, Rating = "A", Mass = 3.5, Integrity = 48, Power = 1.2, BootTime = 0, ShieldReinforcement = 20, KineticResistance = 0, ThermalResistance = 0, ExplosiveResistance = 0 } },
                ...
                { "int_shieldgenerator_size2_class2", new ShipModule(128064264,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 2 Rating D"){ Cost = 5930, Class = 2, Rating = "D", Mass = 1, Integrity = 31, Power = 1.2, BootTime = 1, MinMass = 28, OptMass = 55, MaxMass = 138, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 1, BrokenRegenRate = 1.6, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size2_class4", new ShipModule(128064266,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 2 Rating B"){ Cost = 53410, Class = 2, Rating = "B", Mass = 4, Integrity = 71, Power = 1.8, BootTime = 1, MinMass = 28, OptMass = 55, MaxMass = 138, MinStrength = 60, OptStrength = 110, MaxStrength = 160, RegenRate = 1, BrokenRegenRate = 1.6, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size2_class5", new ShipModule(128064267,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 2 Rating A"){ Cost = 160220, Class = 2, Rating = "A", Mass = 2.5, Integrity = 61, Power = 2.1, BootTime = 1, MinMass = 28, OptMass = 55, MaxMass = 138, MinStrength = 70, OptStrength = 120, MaxStrength = 170, RegenRate = 1, BrokenRegenRate = 1.6, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size4_class2", new ShipModule(128064274,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 4 Rating D"){ Cost = 59630, Class = 4, Rating = "D", Mass = 4, Integrity = 48, Power = 1.76, BootTime = 1, MinMass = 143, OptMass = 285, MaxMass = 713, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 1, BrokenRegenRate = 2.53, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size4_class5", new ShipModule(128064277,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 4 Rating A"){ Cost = 1610080, Class = 4, Rating = "A", Mass = 10, Integrity = 96, Power = 3.08, BootTime = 1, MinMass = 143, OptMass = 285, MaxMass = 713, MinStrength = 70, OptStrength = 120, MaxStrength = 170, RegenRate = 1, BrokenRegenRate = 2.53, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size5_class2", new ShipModule(128064279,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 5 Rating D"){ Cost = 189040, Class = 5, Rating = "D", Mass = 8, Integrity = 58, Power = 2.08, BootTime = 1, MinMass = 203, OptMass = 405, MaxMass = 1013, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 1, BrokenRegenRate = 3.75, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size5_class4", new ShipModule(128064281,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 5 Rating B"){ Cost = 1701320, Class = 5, Rating = "B", Mass = 32, Integrity = 134, Power = 3.12, BootTime = 1, MinMass = 203, OptMass = 405, MaxMass = 1013, MinStrength = 60, OptStrength = 110, MaxStrength = 160, RegenRate = 1, BrokenRegenRate = 3.75, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size6_class2", new ShipModule(128064284,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 6 Rating D"){ Cost = 599240, Class = 6, Rating = "D", Mass = 16, Integrity = 68, Power = 2.48, BootTime = 1, MinMass = 270, OptMass = 540, MaxMass = 1350, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 1.3, BrokenRegenRate = 5.33, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size7_class2", new ShipModule(128064289,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 7 Rating D"){ Cost = 1899600, Class = 7, Rating = "D", Mass = 32, Integrity = 79, Power = 2.8, BootTime = 1, MinMass = 530, OptMass = 1060, MaxMass = 2650, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 1.8, BrokenRegenRate = 7.33, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size7_class4", new ShipModule(128064291,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 7 Rating B"){ Cost = 17096370, Class = 7, Rating = "B", Mass = 128, Integrity = 183, Power = 4.2, BootTime = 1, MinMass = 530, OptMass = 1060, MaxMass = 2650, MinStrength = 60, OptStrength = 110, MaxStrength = 160, RegenRate = 1.8, BrokenRegenRate = 7.33, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size7_class5", new ShipModule(128064292,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 7 Rating A"){ Cost = 51289110, Class = 7, Rating = "A", Mass = 80, Integrity = 157, Power = 4.9, BootTime = 1, MinMass = 530, OptMass = 1060, MaxMass = 2650, MinStrength = 70, OptStrength = 120, MaxStrength = 170, RegenRate = 1.8, BrokenRegenRate = 7.33, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size8_class2", new ShipModule(128064294,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 8 Rating D"){ Cost = 6021720, Class = 8, Rating = "D", Mass = 64, Integrity = 90, Power = 3.2, BootTime = 1, MinMass = 900, OptMass = 1800, MaxMass = 4500, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 2.4, BrokenRegenRate = 9.6, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size8_class4", new ShipModule(128064296,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 8 Rating B"){ Cost = 54195500, Class = 8, Rating = "B", Mass = 256, Integrity = 210, Power = 4.8, BootTime = 1, MinMass = 900, OptMass = 1800, MaxMass = 4500, MinStrength = 60, OptStrength = 110, MaxStrength = 160, RegenRate = 2.4, BrokenRegenRate = 9.6, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size8_class5", new ShipModule(128064297,ShipModule.ModuleTypes.ShieldGenerator,"Shield Generator Class 8 Rating A"){ Cost = 162586490, Class = 8, Rating = "A", Mass = 160, Integrity = 180, Power = 5.6, BootTime = 1, MinMass = 900, OptMass = 1800, MaxMass = 4500, MinStrength = 70, OptStrength = 120, MaxStrength = 170, RegenRate = 2.4, BrokenRegenRate = 9.6, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size2_class5_strong", new ShipModule(128671324,ShipModule.ModuleTypes.PrismaticShieldGenerator,"Prismatic Shield Generator Class 2 Rating A"){ Cost = 240340, Class = 2, Rating = "A", Mass = 5, Integrity = 61, Power = 3.15, BootTime = 1, MinMass = 28, OptMass = 55, MaxMass = 138, MinStrength = 100, OptStrength = 150, MaxStrength = 200, RegenRate = 1, BrokenRegenRate = 1.2, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size3_class5_strong", new ShipModule(128671325,ShipModule.ModuleTypes.PrismaticShieldGenerator,"Prismatic Shield Generator Class 3 Rating A"){ Cost = 761870, Class = 3, Rating = "A", Mass = 10, Integrity = 77, Power = 3.78, BootTime = 1, MinMass = 83, OptMass = 165, MaxMass = 413, MinStrength = 100, OptStrength = 150, MaxStrength = 200, RegenRate = 1, BrokenRegenRate = 1.3, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size4_class5_strong", new ShipModule(128671326,ShipModule.ModuleTypes.PrismaticShieldGenerator,"Prismatic Shield Generator Class 4 Rating A"){ Cost = 2415120, Class = 4, Rating = "A", Mass = 20, Integrity = 96, Power = 4.62, BootTime = 1, MinMass = 143, OptMass = 285, MaxMass = 713, MinStrength = 100, OptStrength = 150, MaxStrength = 200, RegenRate = 1, BrokenRegenRate = 1.66, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size5_class5_strong", new ShipModule(128671327,ShipModule.ModuleTypes.PrismaticShieldGenerator,"Prismatic Shield Generator Class 5 Rating A"){ Cost = 7655930, Class = 5, Rating = "A", Mass = 40, Integrity = 115, Power = 5.46, BootTime = 1, MinMass = 203, OptMass = 405, MaxMass = 1013, MinStrength = 100, OptStrength = 150, MaxStrength = 200, RegenRate = 1, BrokenRegenRate = 2.34, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size6_class5_strong", new ShipModule(128671328,ShipModule.ModuleTypes.PrismaticShieldGenerator,"Prismatic Shield Generator Class 6 Rating A"){ Cost = 24269300, Class = 6, Rating = "A", Mass = 80, Integrity = 136, Power = 6.51, BootTime = 1, MinMass = 270, OptMass = 540, MaxMass = 1350, MinStrength = 100, OptStrength = 150, MaxStrength = 200, RegenRate = 1, BrokenRegenRate = 3.2, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size7_class5_strong", new ShipModule(128671329,ShipModule.ModuleTypes.PrismaticShieldGenerator,"Prismatic Shield Generator Class 7 Rating A"){ Cost = 76933670, Class = 7, Rating = "A", Mass = 160, Integrity = 157, Power = 7.35, BootTime = 1, MinMass = 530, OptMass = 1060, MaxMass = 2650, MinStrength = 100, OptStrength = 150, MaxStrength = 200, RegenRate = 1.1, BrokenRegenRate = 4.25, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size3_class3_fast", new ShipModule(128671333,ShipModule.ModuleTypes.Bi_WeaveShieldGenerator,"Bi Weave Shield Generator Class 3 Rating C"){ Cost = 84650, Class = 3, Rating = "C", Mass = 5, Integrity = 64, Power = 1.8, BootTime = 1, MinMass = 83, OptMass = 165, MaxMass = 413, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 1.8, BrokenRegenRate = 2.8, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size4_class3_fast", new ShipModule(128671334,ShipModule.ModuleTypes.Bi_WeaveShieldGenerator,"Bi Weave Shield Generator Class 4 Rating C"){ Cost = 268350, Class = 4, Rating = "C", Mass = 10, Integrity = 80, Power = 2.2, BootTime = 1, MinMass = 143, OptMass = 285, MaxMass = 713, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 1.8, BrokenRegenRate = 3.8, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size5_class3_fast", new ShipModule(128671335,ShipModule.ModuleTypes.Bi_WeaveShieldGenerator,"Bi Weave Shield Generator Class 5 Rating C"){ Cost = 850660, Class = 5, Rating = "C", Mass = 20, Integrity = 96, Power = 2.6, BootTime = 1, MinMass = 203, OptMass = 405, MaxMass = 1013, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 2.2, BrokenRegenRate = 5.63, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                { "int_shieldgenerator_size6_class3_fast", new ShipModule(128671336,ShipModule.ModuleTypes.Bi_WeaveShieldGenerator,"Bi Weave Shield Generator Class 6 Rating C"){ Cost = 2696590, Class = 6, Rating = "C", Mass = 40, Integrity = 113, Power = 3.1, BootTime = 1, MinMass = 270, OptMass = 540, MaxMass = 1350, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 3.2, BrokenRegenRate = 8, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
                ...
                { "int_shieldgenerator_size8_class3_fast", new ShipModule(128671338,ShipModule.ModuleTypes.Bi_WeaveShieldGenerator,"Bi Weave Shield Generator Class 8 Rating C"){ Cost = 27097750, Class = 8, Rating = "C", Mass = 160, Integrity = 150, Power = 4, BootTime = 1, MinMass = 900, OptMass = 1800, MaxMass = 4500, MinStrength = 40, OptStrength = 90, MaxStrength = 140, RegenRate = 5.8, BrokenRegenRate = 14.4, MWPerUnit = 0.6, KineticResistance = 40, ThermalResistance = -20, ExplosiveResistance = 50, AXResistance = 95 } },
