...
namespace EliteDangerousCore
{
    public partial class ItemData
    {
        ...
        public static Dictionary<string, ShipModule> othermodules = new Dictionary<string, ShipModule>   // DO NOT USE DIRECTLY - public is for checking only
        {
            ...
            { "modularcargobaydoorfdl", new ShipModule(-1,0,0,null,"FDL Cargo Bay Door",CargoBayDoorType) },
            { "modularcargobaydoor", new ShipModule(-1,0,0,null,"Modular Cargo Bay Door",CargoBayDoorType) },

            { "int_corrosionproofcargorack_size5_class1", new ShipModule(-1,0,0,null,"Int Corrosionproofcargorack Size 5 Class 1","Cargo Rack") },

            { "hpt_cargoscanner_basic_tiny", new ShipModule(-1,0,0,null,"Cargo Scanner Basic Tiny","Cargo Scanner") },

            { "adder_cockpit", new ShipModule(-1,0,0,null,"Adder Cockpit",CockpitType) },
            { "typex_3_cockpit", new ShipModule(-1,0,0,null,"Alliance Challenger Cockpit",CockpitType) },
            { "typex_cockpit", new ShipModule(-1,0,0,null,"Alliance Chieftain Cockpit",CockpitType) },
            { "anaconda_cockpit", new ShipModule(-1,0,0,null,"Anaconda Cockpit",CockpitType) },
            { "asp_cockpit", new ShipModule(-1,0,0,null,"Asp Cockpit",CockpitType) },
            { "asp_scout_cockpit", new ShipModule(-1,0,0,null,"Asp Scout Cockpit",CockpitType) },
            { "belugaliner_cockpit", new ShipModule(-1,0,0,null,"Beluga Cockpit",CockpitType) },
            { "cobramkiii_cockpit", new ShipModule(-1,0,0,null,"Cobra Mk III Cockpit",CockpitType) },
            { "cobramkiv_cockpit", new ShipModule(-1,0,0,null,"Cobra Mk IV Cockpit",CockpitType) },
            { "cutter_cockpit", new ShipModule(-1,0,0,null,"Cutter Cockpit",CockpitType) },
            { "diamondbackxl_cockpit", new ShipModule(-1,0,0,null,"Diamondback Explorer Cockpit",CockpitType) },
            { "diamondback_cockpit", new ShipModule(-1,0,0,null,"Diamondback Scout Cockpit",CockpitType) },
            { "dolphin_cockpit", new ShipModule(-1,0,0,null,"Dolphin Cockpit",CockpitType) },
            { "eagle_cockpit", new ShipModule(-1,0,0,null,"Eagle Cockpit",CockpitType) },
            { "empire_courier_cockpit", new ShipModule(-1,0,0,null,"Empire Courier Cockpit",CockpitType) },
            { "empire_eagle_cockpit", new ShipModule(-1,0,0,null,"Empire Eagle Cockpit",CockpitType) },
            { "empire_fighter_cockpit", new ShipModule(-1,0,0,null,"Empire Fighter Cockpit",CockpitType) },
            { "empire_trader_cockpit", new ShipModule(-1,0,0,null,"Empire Trader Cockpit",CockpitType) },
            { "federation_corvette_cockpit", new ShipModule(-1,0,0,null,"Federal Corvette Cockpit",CockpitType) },
            { "federation_dropship_mkii_cockpit", new ShipModule(-1,0,0,null,"Federal Dropship Cockpit",CockpitType) },
            { "federation_dropship_cockpit", new ShipModule(-1,0,0,null,"Federal Gunship Cockpit",CockpitType) },
            { "federation_gunship_cockpit", new ShipModule(-1,0,0,null,"Federal Gunship Cockpit",CockpitType) },
            { "federation_fighter_cockpit", new ShipModule(-1,0,0,null,"Federation Fighter Cockpit",CockpitType) },
            { "ferdelance_cockpit", new ShipModule(-1,0,0,null,"Fer De Lance Cockpit",CockpitType) },
            { "hauler_cockpit", new ShipModule(-1,0,0,null,"Hauler Cockpit",CockpitType) },
            { "independant_trader_cockpit", new ShipModule(-1,0,0,null,"Independant Trader Cockpit",CockpitType) },
            { "independent_fighter_cockpit", new ShipModule(-1,0,0,null,"Independent Fighter Cockpit",CockpitType) },
            { "krait_light_cockpit", new ShipModule(-1,0,0,null,"Krait Light Cockpit",CockpitType) },
            { "krait_mkii_cockpit", new ShipModule(-1,0,0,null,"Krait MkII Cockpit",CockpitType) },
            { "mamba_cockpit", new ShipModule(-1,0,0,null,"Mamba Cockpit",CockpitType) },
            { "orca_cockpit", new ShipModule(-1,0,0,null,"Orca Cockpit",CockpitType) },
            { "python_cockpit", new ShipModule(-1,0,0,null,"Python Cockpit",CockpitType) },
            { "sidewinder_cockpit", new ShipModule(-1,0,0,null,"Sidewinder Cockpit",CockpitType) },
            { "type6_cockpit", new ShipModule(-1,0,0,null,"Type 6 Cockpit",CockpitType) },
            { "type7_cockpit", new ShipModule(-1,0,0,null,"Type 7 Cockpit",CockpitType) },
            { "type9_cockpit", new ShipModule(-1,0,0,null,"Type 9 Cockpit",CockpitType) },
            { "type9_military_cockpit", new ShipModule(-1,0,0,null,"Type 9 Military Cockpit",CockpitType) },
            { "typex_2_cockpit", new ShipModule(-1,0,0,null,"Typex 2 Cockpit",CockpitType) },
            { "viper_cockpit", new ShipModule(-1,0,0,null,"Viper Cockpit",CockpitType) },
            { "viper_mkiv_cockpit", new ShipModule(-1,0,0,null,"Viper Mk IV Cockpit",CockpitType) },
            { "vulture_cockpit", new ShipModule(-1,0,0,null,"Vulture Cockpit",CockpitType) },
            ...
            { "ext_emitter_guardian", new ShipModule(-1,0,0,null,"Ext Emitter Guardian","Fighter Module") },
            { "ext_emitter_standard", new ShipModule(-1,0,0,null,"Ext Emitter Standard","Fighter Module") },
            { "gdn_hybrid_fighter_v1_armour_standard", new ShipModule(-1,0,0,null,"GDN Hybrid Fighter V 1 Armour Standard","Fighter Module") },
            { "gdn_hybrid_fighter_v1_cockpit", new ShipModule(-1,0,0,null,"GDN Hybrid Fighter V 1 Cockpit","Fighter Module") },
            { "gdn_hybrid_fighter_v2_armour_standard", new ShipModule(-1,0,0,null,"GDN Hybrid Fighter V 2 Armour Standard","Fighter Module") },
            { "gdn_hybrid_fighter_v2_cockpit", new ShipModule(-1,0,0,null,"GDN Hybrid Fighter V 2 Cockpit","Fighter Module") },
            { "gdn_hybrid_fighter_v3_armour_standard", new ShipModule(-1,0,0,null,"GDN Hybrid Fighter V 3 Armour Standard","Fighter Module") },
            { "gdn_hybrid_fighter_v3_cockpit", new ShipModule(-1,0,0,null,"GDN Hybrid Fighter V 3 Cockpit","Fighter Module") },
            ...
            { "string_lights_coloured", new ShipModule(-1,0,0,null,"String Lights Coloured",VanityType) },
            { "string_lights_thargoidprobe", new ShipModule(-1,0,0,null,"String Lights Thargoid probe",VanityType) },
            { "string_lights_warm_white", new ShipModule(-1,0,0,null,"String Lights Warm White",VanityType) },
            ...
            { "voicepack_verity", new ShipModule(-1,0,0,null,"Voice Pack Verity",VanityType) },
            ...
            { "voicepack_celeste", new ShipModule(-1,0,0,null,"Voicepack Celeste",VanityType) },
            ...
            { "voicepack_victor", new ShipModule(-1,0,0,null,"Voicepack Victor",VanityType) },
