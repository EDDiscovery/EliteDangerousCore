...
{
    [System.Diagnostics.DebuggerDisplay("Rec {FDName.Str()} {Level} {Name} {ModuleListSplitCaps} {string.Join(\",\",Engineers)}")]
    public class EngineeringRecipe : RecipeBase
    {
        ...
        // normal recipes
        // ingredients may be empty and engnrs may be empty
        public EngineeringRecipe(string name, string fdname, string ingredientlist, ItemData.ShipModule.ModuleTypes moduletype, int lvl, string engnrs, int merccoins = 0)   
        ...
        public EngineeringRecipe(string name, string fdname, string moduletypelist, string ingredientlist)        // for special effects
            : base(name, ingredientlist)
        {
            this.FDName = new EngineeringRecipeFDName(fdname);
        ...
        public EngineeringRecipe(string name, string fdname, ItemData.ShipModule.ModuleTypes moduletype, string ingredientlist)        // for special effects
            : base(name, ingredientlist)
        {
            this.FDName = new EngineeringRecipeFDName(fdname);
            ModuleType = new ItemData.ShipModule.ModuleTypes[] { moduletype };
        ...
        public static string GetBetterNameForEngineeringRecipeFDName(EngineeringRecipeFDName fdname)
        {
        ...
        public static EngineeringRecipe FindEngineeringFDName(EngineeringRecipeFDName fdname)
        {
        ...
        // ones which players can engineeer - an empty ingredients list indicates ones which they can't
        public static IEnumerable<EngineeringRecipe> GetPlayerEngineering()
        {
            return engineeringRecipes.Where(x => x.Ingredients.Length > 0 && x.Engineers.Length>0);
        }
        ...
        new EngineeringRecipe("Decorative Green", "decorative_green", "1P" , ItemData.ShipModule.ModuleTypes.RemoteReleaseFlakLauncher, 5, ""),
        new EngineeringRecipe("Decorative Yellow", "decorative_yellow", "1P" , ItemData.ShipModule.ModuleTypes.RemoteReleaseFlakLauncher, 5, ""),
        new EngineeringRecipe("Decorative Red", "decorative_red", "1P" , ItemData.ShipModule.ModuleTypes.RemoteReleaseFlakLauncher, 5, ""),
        new EngineeringRecipe("Decorative Pink", "decorative_pink", "1P" , ItemData.ShipModule.ModuleTypes.RemoteReleaseFlakLauncher, 5, ""),
        ...
        // its in the logs but can't match to Inara - made up
        new EngineeringRecipe("Expanded Probe Scanning Radius", "sensor_fastscan", "", ItemData.ShipModule.ModuleTypes.SurfaceScanner, 5, "" ),     
