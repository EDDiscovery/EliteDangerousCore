...
using System.Linq;
using static EliteDangerousCore.ItemData.Weapon;
using static ExtendedControls.ExtButtonDrawn;

namespace EliteDangerousCore
{
    public partial class ItemData
    {
        static public Weapon GetWeapon(string fdname, string locname = null)         // suit weapons only
        {
            HandItem hi = GetWeaponOrHandItem(fdname, locname);
            return hi as Weapon;        // null if not
        }

        static public HandItem GetWeaponOrHandItem(string fdname, string locname = null)   // all hand items
        {
            fdname = fdname.ToLowerInvariant();
            if (weapons.TryGetValue(fdname, out Weapon var))
                return var;
            else if (onfoothanditems.TryGetValue(fdname, out HandItem var2))
                return var2;
            else
            {
                System.Diagnostics.Debug.WriteLine("Unknown Weapon/Hand Item: {{ \"{0}\", new Weapon(\"{1}\",0.0) }},", fdname, locname ?? fdname.SplitCapsWordFull());
                return null;
            }
        }

        [System.Diagnostics.DebuggerDisplay("{Name} {Class}")]
        public class HandItem
        {
            public string Name;     // nice english name
            public enum HandItemClass { Launcher, Carbine, LongRangeRifle, Rifle, ShotGun, Pistol, Analyser, Fists, Utility }
            public HandItemClass Class;
            public HandItem(string name, HandItemClass ds)
            {
                Name = name;
                Class = ds;
            }
        ...
        [System.Diagnostics.DebuggerDisplay("{Name} P:{Primary} {Class} {DamageType} {FireMode}")]
        public class Weapon  : HandItem
        {
            ...
            public Weapon(string fdname, bool primary, WeaponDamageType ty, HandItemClass wclass, WeaponFireMode fr, WeaponStats[] values) : base(fdname,wclass)
            {
                Primary = primary;
                DamageType = ty;
                FireMode = fr;
        ...
        public static Dictionary<string, HandItem> onfoothanditems = new Dictionary<string, HandItem>   // DO NOT USE DIRECTLY - public is for checking only
        {
            { "humanoid_fists", new HandItem("Fists", HandItem.HandItemClass.Fists) },
            { "humanoid_rechargetool", new HandItem("Recharger", HandItem.HandItemClass.Utility) },
            { "humanoid_companalyser", new HandItem("Profile Analyser", HandItem.HandItemClass.Utility) },
            { "humanoid_sampletool", new HandItem("Genetic Sampler", HandItem.HandItemClass.Utility) },
            { "humanoid_repairtool", new HandItem("Arc Cutter", HandItem.HandItemClass.Utility) },
        };
        ...
        {
             { "wpn_m_assaultrifle_kinetic_fauto", new Weapon("Karma AR-50", true, Weapon.WeaponDamageType.Kinetic, Weapon.HandItemClass.LongRangeRifle, Weapon.WeaponFireMode.Automatic,new WeaponStats[] {
             ...
             { "wpn_m_submachinegun_kinetic_fauto", new Weapon("Karma C-44", true, Weapon.WeaponDamageType.Kinetic, Weapon.HandItemClass.Carbine, Weapon.WeaponFireMode.Automatic, new WeaponStats[] {
             ...
             { "wpn_s_pistol_kinetic_sauto", new Weapon("Karma P-15", false, Weapon.WeaponDamageType.Kinetic, Weapon.HandItemClass.Pistol, Weapon.WeaponFireMode.SemiAutomatic, new WeaponStats[] {
            ...
            { "wpn_m_launcher_rocket_sauto", new Weapon("Karma L-6", true, Weapon.WeaponDamageType.Explosive, Weapon.HandItemClass.Launcher, Weapon.WeaponFireMode.Automatic, new WeaponStats[] {
             ...
             { "wpn_m_assaultrifle_laser_fauto", new Weapon("TK Aphelion", true, Weapon.WeaponDamageType.Thermal, Weapon.HandItemClass.Rifle, Weapon.WeaponFireMode.Automatic, new WeaponStats[] {
             ...
             { "wpn_m_submachinegun_laser_fauto", new Weapon("TK Eclipse", true, Weapon.WeaponDamageType.Thermal, Weapon.HandItemClass.Carbine, Weapon.WeaponFireMode.Automatic, new WeaponStats[] {
             ...
             { "wpn_s_pistol_laser_sauto", new Weapon("TK Zenith", false, Weapon.WeaponDamageType.Thermal, Weapon.HandItemClass.Pistol, Weapon.WeaponFireMode.Burst, new WeaponStats[] {
            ...
            { "wpn_m_sniper_plasma_charged", new Weapon("Manticore Executioner", true, Weapon.WeaponDamageType.Plasma, Weapon.HandItemClass.LongRangeRifle, Weapon.WeaponFireMode.SemiAutomatic,new WeaponStats[] {
            ...
            { "wpn_m_assaultrifle_plasma_fauto", new Weapon("Manticore Oppressor", true, Weapon.WeaponDamageType.Plasma, Weapon.HandItemClass.Rifle, Weapon.WeaponFireMode.Automatic, new WeaponStats[] {
            ...
            { "wpn_m_shotgun_plasma_doublebarrel", new Weapon("Manticore Intimidator", true,  Weapon.WeaponDamageType.Plasma, Weapon.HandItemClass.ShotGun, Weapon.WeaponFireMode.SemiAutomatic,new WeaponStats[] {
            ...
            { "wpn_s_pistol_plasma_charged", new Weapon("Manticore Tormentor", false, Weapon.WeaponDamageType.Plasma, Weapon.HandItemClass.Pistol, Weapon.WeaponFireMode.SemiAutomatic, new WeaponStats[] {
