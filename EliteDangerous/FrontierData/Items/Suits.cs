...
namespace EliteDangerousCore
{
    ...
    {
        static public Suit GetSuit(SuitFDName fdname, string locname = null)         // suit weapons
        {
        ...
        public static Dictionary<SuitFDName, Suit> suit = new Dictionary<SuitFDName, Suit>(new SuitFDNameEqualityComparer())   // DO NOT USE DIRECTLY - public is for checking only
        {
                ...
                7, 60, 5,10,10 )) }, // battery, oxygen, items, components, data     
                 ...
                 { new SuitFDName("tacticalsuit_class1"), new Suit( "Dominator Suit", 1, 2, 1, "Energylink", "Profile Analyser", "",
                ...
                10, 60, 5,10,10 )) }, // battery, oxygen, items, components, data : correct
                 ...
                 { new SuitFDName("tacticalsuit_class2"), new Suit( "Dominator Suit", 2, 2, 1, "Energylink", "Profile Analyser", "",
                new SuitStats( 1.26, 0.34, 0.84, 0.84, // health kinetic, thermal, plasma, explosive : correct
                0.4, 1.5, 1, 0.5, // shield kinetic, thermal, plasma, explosive
                1.34, 18.3, // regen, shield health correct
                10, 60, 5,10,10 )) }, // battery, oxygen, items, components, data correct

                 { new SuitFDName("tacticalsuit_class3"), new Suit( "Dominator Suit", 3, 2, 1, "Energylink", "Profile Analyser", "",
                new SuitStats( 1.07, 0.28, 0.71, 0.71, // health kinetic, thermal, plasma, explosive : correct
                0.4, 1.5, 1, 0.5, // shield kinetic, thermal, plasma, explosive
                1.65, 22.5, // regen, shield health correct
                10, 60, 5,10,10 )) }, // battery, oxygen, items, components, data correct

                 { new SuitFDName("tacticalsuit_class4"), new Suit( "Dominator Suit", 4, 2, 1, "Energylink", "Profile Analyser", "",
                ...
                10, 60, 5,10,10 )) }, // battery, oxygen, items, components, data
                 ...
                 { new SuitFDName("tacticalsuit_class5"), new Suit( "Dominator Suit", 5, 2, 1, "Energylink", "Profile Analyser", "",
                ...
                10, 60, 5,10,10 )) }, // battery, oxygen, items, components, data
                 ...
                 { new SuitFDName("explorationsuit_class1"), new Suit( "Artemis Suit", 1, 1, 1, "Energylink", "Profile Analyser", "Genetic Sampler",
                ...
                17, 60, 10,20,10 )) }, // battery, oxygen, items, components, data : correct
                 ...
                 { new SuitFDName("explorationsuit_class2"), new Suit( "Artemis Suit", 2, 1, 1, "Energylink", "Profile Analyser", "Genetic Sampler",
                ...
                17, 60, 10,20,10 )) }, // battery, oxygen, items, components, data : correct
                 ...
                 { new SuitFDName("explorationsuit_class3"), new Suit( "Artemis Suit", 3, 1, 1, "Energylink", "Profile Analyser", "Genetic Sampler",
                ...
                17, 60, 10,20,10 )) }, // battery, oxygen, items, components, data Correct
                 ...
                 { new SuitFDName("explorationsuit_class4"), new Suit( "Artemis Suit", 4, 1, 1, "Energylink", "Profile Analyser", "Genetic Sampler",
                ...
                17, 60, 10,20,10 )) }, // battery, oxygen, items, components, data
                 ...
                 { new SuitFDName("explorationsuit_class5"), new Suit( "Artemis Suit", 5, 1, 1, "Energylink", "Profile Analyser", "Genetic Sampler",
                ...
                17, 60, 10,20,10 )) }, // battery, oxygen, items, components, data
                 ...
                 { new SuitFDName("utilitysuit_class1"), new Suit( "Maverick Suit", 1, 1, 1, "Energylink", "Profile Analyser", "Arc Cutter",
                ...
                13.5, 60, 15,30,10 )) }, // battery, oxygen, items, components, data correct
                 ...
                 { new SuitFDName("utilitysuit_class2"), new Suit( "Maverick Suit", 2, 1, 1, "Energylink", "Profile Analyser", "Arc Cutter",
                ...
                13.5, 60, 15,30,10 )) }, // battery, oxygen, items, components, data correct 
                 ...
                 { new SuitFDName("utilitysuit_class3"), new Suit( "Maverick Suit", 3, 1, 1, "Energylink", "Profile Analyser", "Arc Cutter",
                ...
                13.5, 60, 15,30,10 )) }, // battery, oxygen, items, components, data    // 20/8/21
                 ...
                 { new SuitFDName("utilitysuit_class4"), new Suit( "Maverick Suit", 4, 1, 1, "Energylink", "Profile Analyser", "Arc Cutter",
                ...
                13.5, 60, 15,30,10 )) }, // battery, oxygen, items, components, data
                 ...
                 { new SuitFDName("utilitysuit_class5"), new Suit( "Maverick Suit", 5, 1, 1, "Energylink", "Profile Analyser", "Arc Cutter",
                ...
                13.5, 60, 15,30,10 )) }, // battery, oxygen, items, components, data
                 ...
                 { new SuitFDName("flightsuitai"), new Suit("AI Flight Suit",1,0,0,"","","",null) },
                 { new SuitFDName("lightassaultsuitai_class1"), new Suit("AI Light Assault Suit",1,0,0,"","","",null) },
                 { new SuitFDName("lightassaultsuitai_class2"), new Suit("AI Light Assault Suit",2,0,0,"","","",null) },
                 { new SuitFDName("lightassaultsuitai_class3"), new Suit("AI Light Assault Suit",3,0,0,"","","",null) },
                 { new SuitFDName("lightassaultsuitai_class4"), new Suit("AI Light Assault Suit",4,0,0,"","","",null) },
                 { new SuitFDName("lightassaultsuitai_class5"), new Suit("AI Light Assault Suit", 5, 0, 0, "", "", "", null) },

                 { new SuitFDName("assaultsuitai_class1"), new Suit("AI Assault Suit",1,0,0,"","","",null) },
                 { new SuitFDName("assaultsuitai_class2"), new Suit("AI Assault Suit",2,0,0,"","","",null) },
                 { new SuitFDName("assaultsuitai_class3"), new Suit("AI Assault Suit",3,0,0,"","","",null) },
                 { new SuitFDName("assaultsuitai_class4"), new Suit("AI Assault Suit", 4, 0, 0, "", "", "", null) },
                 { new SuitFDName("assaultsuitai_class5"), new Suit("AI Assault Suit", 5, 0, 0, "", "", "", null) },

                 { new SuitFDName("closesuitai_class1"), new Suit("AI Close Suit", 1, 0, 0, "", "", "", null) },
                 { new SuitFDName("closesuitai_class2"), new Suit("AI Close Suit", 2, 0, 0, "", "", "", null) },
                 { new SuitFDName("closesuitai_class3"), new Suit("AI Close Suit", 3, 0, 0, "", "", "", null) },
                 { new SuitFDName("closesuitai_class4"), new Suit("AI Close Suit", 4, 0, 0, "", "", "", null) },
                 { new SuitFDName("closesuitai_class5"), new Suit("AI Close Suit", 5, 0, 0, "", "", "", null) },

                 { new SuitFDName("rangedsuitai_class1"), new Suit("AI Ranger Suit", 1, 0, 0, "", "", "", null) },
                 { new SuitFDName("rangedsuitai_class2"), new Suit("AI Ranger Suit", 2, 0, 0, "", "", "", null) },
                 { new SuitFDName("rangedsuitai_class3"), new Suit("AI Ranger Suit", 3, 0, 0, "", "", "", null) },
                 { new SuitFDName("rangedsuitai_class4"), new Suit("AI Ranger Suit", 4, 0, 0, "", "", "", null) },
                 { new SuitFDName("rangedsuitai_class5"), new Suit("AI Ranger Suit", 5, 0, 0, "", "", "", null) },

                 { new SuitFDName("heavysuitai_class1"), new Suit("AI Heavy Suit", 1, 0, 0, "", "", "", null) },
                 { new SuitFDName("heavysuitai_class2"), new Suit("AI Heavy Suit", 2, 0, 0, "", "", "", null) },
                 { new SuitFDName("heavysuitai_class3"), new Suit("AI Heavy Suit", 3, 0, 0, "", "", "", null) },       
                 { new SuitFDName("heavysuitai_class4"), new Suit("AI Heavy Suit", 4, 0, 0, "", "", "", null) },       
                 { new SuitFDName("heavysuitai_class5"), new Suit("AI Heavy Suit", 5, 0, 0, "", "", "", null) },

                 { new SuitFDName("citizensuitai_admin"), new Suit("AI Citizen Suit Admin", 0, 0, 0, "", "", "", null) },
                 { new SuitFDName("citizensuitai_scientific"), new Suit("AI Citizen Suit Scientific", 0, 0, 0, "", "", "", null) },
                 { new SuitFDName("citizensuitai_industrial"), new Suit("AI Citizen Suit Industrial", 0, 0, 0, "", "", "", null) },
