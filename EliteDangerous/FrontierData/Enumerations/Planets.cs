...
namespace EliteDangerousCore
{
    ...
    public class Planets
    {
        ...
        {
            [EDPlanet.Metal_rich_body] = "Metal-rich body".Tx(),
            [EDPlanet.High_metal_content_body] = "High metal content world".Tx(),
            [EDPlanet.Rocky_body] = "Rocky body".Tx(),
            [EDPlanet.Icy_body] = "Icy body".Tx(),
            [EDPlanet.Rocky_ice_body] = "Rocky ice world".Tx(),
            [EDPlanet.Earthlike_body] = "Earth-like world".Tx(),
            [EDPlanet.Water_world] = "Water world".Tx(),
            [EDPlanet.Ammonia_world] = "Ammonia world".Tx(),
            [EDPlanet.Water_giant] = "Water giant".Tx(),
            [EDPlanet.Water_giant_with_life] = "Water giant with life".Tx(),
            [EDPlanet.Gas_giant_with_water_based_life] = "Gas giant with water-based life".Tx(),
            [EDPlanet.Gas_giant_with_ammonia_based_life] = "Gas giant with ammonia-based life".Tx(),
            [EDPlanet.Sudarsky_class_I_gas_giant] = "Class I gas giant".Tx(),
            [EDPlanet.Sudarsky_class_II_gas_giant] = "Class II gas giant".Tx(),
            [EDPlanet.Sudarsky_class_III_gas_giant] = "Class III gas giant".Tx(),
            [EDPlanet.Sudarsky_class_IV_gas_giant] = "Class IV gas giant".Tx(),
            [EDPlanet.Sudarsky_class_V_gas_giant] = "Class V gas giant".Tx(),
            [EDPlanet.Helium_rich_gas_giant] = "Helium-rich gas giant".Tx(),
            [EDPlanet.Helium_gas_giant] = "Helium gas giant".Tx(),
            [EDPlanet.Unknown_Body_Type] = "Unknown planet type".Tx(),
        };
